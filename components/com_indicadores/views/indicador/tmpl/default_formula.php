                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <input id="btnFrmParentesisAbierto" type="button" value="<?php echo JText::_( 'COM_INDICADORES_CALCULADORA_PARENTESIS_ABIERTO_TITLE' ) ?>">
                            <input id="btnFrmParentesisCerrado" type="button" value="<?php echo JText::_( 'COM_INDICADORES_CALCULADORA_PARENTESIS_CERRADO_TITLE' ) ?>">

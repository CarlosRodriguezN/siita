    ...
    function updIndEconomicos( indEconomico )
    {
        ...
        for( var x = 0; x < indEconomico.length; x++ ){
            ...
            switch( indEconomico[x].modeloIndicador ){
                case 'td':
                    ds = objGestionIndicador.indEconomico[0].semaforoImagen();
                ...
                case 'van': 
                    ds = objGestionIndicador.indEconomico[1].semaforoImagen();
                ...
                case 'tir':
                    ds = objGestionIndicador.indEconomico[2].semaforoImagen();

...
GestionIndicador.prototype.existeIndGap = function( idTpoGap )
{
    ...
    for (var x = 0; x < nrg; x++) {
        if( this.lstGAP[x].gapMasculino.lstDimensiones[0].idDimension === idTpoGap ){
            ban = true;
        }
    }
...
GestionIndicador.prototype.delGap = function(idRegGap)
{
    ...
    for (var x = 0; x < nrg; x++) {
        if (this.lstGAP[x].idRegGap == idRegGap) {
            ...
            if (this.lstGAP[x].gapMasculino.idIndicador == 0) {
...
GestionIndicador.prototype.addFilaIndicadorGAP = function( dtaIndGap, ban )
{
    ...
    //  GAP - MASCULINO
    /////////////////////////
    ds = dtaIndGap.gapMasculino.semaforoImagen();
    fila += "       <td align='center' style='vertical-align: middle;'>" + dtaIndGap.gapMasculino.nombreIndicador + "</td>";
    fila += "       <td align='center' style='vertical-align: middle;'>" + dtaIndGap.gapMasculino.umbral + "</td>";
    fila += "       <td align='center' style='vertical-align: middle; width: 20px;'>"
            + "         <a id='aim-gap-" + dtaIndGap.idRegGap + "' onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndGap.gapMasculino.idIndicador +"&tpo=m&tpoIndicador=gap&idRegIndicador="+ dtaIndGap.idRegGap +"&tmpl=component&task=preview\", {size:{x: "+ COM_PROYECTOS_POPUP_ANCHO +", y: "+ COM_PROYECTOS_POPUP_ALTO +" }, handler:\"iframe\"} );'>"
    ...
    //  GAP - FEMENINO
    /////////////////////////
    ds = dtaIndGap.gapFemenino.semaforoImagen();
    fila += "       <td align='center' style='vertical-align: middle;'>" + dtaIndGap.gapFemenino.umbral + "</td>";
    fila += "       <td align='center' style='vertical-align: middle; width: 20px;'>"
    ...
    //  GAP - TOTAL
    /////////////////////////
    ds = dtaIndGap.gapTotal.semaforoImagen();
    fila += "       <td align='center' style='vertical-align: middle;' colspan='2'>" + dtaIndGap.gapTotal.umbral + "</td>";
    
    if( this.roles["core.create"] === true || this.roles["core.edit"] === true ){
        fila+= "    <td align='center' style='vertical-align: middle;'> <a class='updGAP'> Editar </a> </td>"
            + "     <td align='center' style='vertical-align: middle;'> <a class='delGAP'> Eliminar </a> </td>";
    }else{
...
GestionIndicador.prototype.existeIndEIgualdad = function( idEIgualdad )
{
    ...
    for (var x = 0; x < nrei; x++) {
        if ( this.lstEnfIgualdad[x].eiMasculino.lstDimensiones[0].idDimension === idEIgualdad ) {
            ban = true;
        }
    }
...
GestionIndicador.prototype.addFilaIndEIgualdad = function( tpoEnfoque, EIgualdad, dtaIndEIgualdad, ban )
{
    ...
    fila += "       <td align='center' style='vertical-align: middle;'>" + EIgualdad + "</td>"
            + "     <td align='center' style='vertical-align: middle;'>" + tpoEnfoque + "</td>";
    
    /////////////////////////
    //  EI - MASCULINO
    /////////////////////////
    ds = dtaIndEIgualdad.eiMasculino.semaforoImagen();
    fila += "       <td align='center' style='vertical-align: middle;'>" + dtaIndEIgualdad.eiMasculino.umbral + "</td>";
    fila += "       <td align='center' style='vertical-align: middle; width: 20px;'>"
    ...
    //  EI - FEMENINO
    /////////////////////////
    ds = dtaIndEIgualdad.eiFemenino.semaforoImagen();
    fila += "       <td align='center' style='vertical-align: middle;'>" + dtaIndEIgualdad.eiFemenino.umbral + "</td>";
    fila += "       <td align='center' style='vertical-align: middle; width: 20px;'>"
    ...
    //  EI - TOTAL
    /////////////////////////
    ds = dtaIndEIgualdad.eiTotal.semaforoImagen();
    fila += "       <td align='center' colspan='2' style='vertical-align: middle;'>" + dtaIndEIgualdad.eiTotal.umbral + "</td>";
    
    if( this.roles["core.create"] === true || this.roles["core.edit"] === true ){
        fila += "       <td align='center' style='vertical-align: middle;'> <a class='updEI'> Editar </a> </td>"
                + "     <td align='center' style='vertical-align: middle;'> <a class='delEI'> Eliminar </a> </td>";
    }else{
        fila += "       <td align='center' style='vertical-align: middle;'> Editar </td>"
                + "     <td align='center' style='vertical-align: middle;'> Eliminar </td>";
    }
 ...
 * 
 */
GestionIndicador.prototype.existeIndEEcorae = function( idEEcorae )
{
    var nree = this.lstEnfEcorae.length;
    var ban = false;

    for (var x = 0; x < nree; x++) {
        if ( this.lstEnfEcorae[x].eeMasculino.lstDimensiones[0].idDimension === idEEcorae ){
            ban = true;
        }
    }
...
GestionIndicador.prototype.addFilaIndEEcorae = function( EEcorae, dtaIndEEcorae, ban )
{
    ...
    fila += "       <td align='center' style='vertical-align: middle;'>" + EEcorae + "</td>";
    
    /////////////////////////
    //  EE - MASCULINO
    /////////////////////////
    
    ds = dtaIndEEcorae.eeMasculino.semaforoImagen();
    fila += "       <td align='center' style='vertical-align: middle;'>" + dtaIndEEcorae.eeMasculino.umbral + "</td>";
    fila += "       <td align='center' style='vertical-align: middle; width: 20px;'>"
    ...
    //  EE - FEMENINO
    /////////////////////////
    ds = dtaIndEEcorae.eeFemenino.semaforoImagen();
    fila += "       <td align='center' style='vertical-align: middle;'>" + dtaIndEEcorae.eeFemenino.umbral + "</td>";
    fila += "       <td align='center' style='vertical-align: middle; width: 20px;'>"
    ...
    //  EE - TOTAL
    /////////////////////////
    ds = dtaIndEEcorae.eeTotal.semaforoImagen();
    fila += "       <td align='center' colspan='2' style='vertical-align: middle;'>" + dtaIndEEcorae.eeTotal.umbral + "</td>";
    
    if( this.roles["core.create"] === true || this.roles["core.edit"] === true ){
        fila+= "<td align='center' style='vertical-align: middle;'> <a class='updEE'> Editar </a> </td>"
            + " <td align='center' style='vertical-align: middle;'> <a class='delEE'> Eliminar </a> </td>";
    }else{
        fila+= "<td align='center' style='vertical-align: middle;'> Editar </td>"
            + " <td align='center' style='vertical-align: middle;'> Eliminar </td>";
    }
...
GestionIndicador.prototype.addFilaOtroIndicador = function( objOtroInd, ban )
{
    ...
    var ds = objOtroInd.semaforoImagen();

    fila += "       <td align='center' style='vertical-align: middle;'> <img src='"+ ds["imgAtributo"] +"' style='padding-left: 11px;' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"'> </td>"
            + "     <td align='left' style='vertical-align: middle;'>" + objOtroInd.nombreIndicador + "</td>"
            + "     <td align='left' style='vertical-align: middle;'>" + objOtroInd.descripcion + "</td>"
            + "     <td align='left' style='vertical-align: middle;'>" + objOtroInd.umbral + ' / ' + objOtroInd.undMedida + "</td>"
            + "     <td align='left' style='vertical-align: middle;'>" + objOtroInd.formula + "</td>";
    
    fila += "       <td align='center' style='vertical-align: middle; width: 70px;'>";
    fila += "           <a onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=tableu&layout=edit&idIndicador="+ objOtroInd.idIndicador +"&tmpl=component&task=preview\", {size:{x: "+ COM_PROYECTOS_POPUP_TABLEU_ANCHO +", y: "+ COM_PROYECTOS_POPUP_TABLEU_ALTO +"}, handler:\"iframe\"} );'> "+ COM_PROYECTOS_POPUP_TABLEU +" </a>";
    fila += "       </td>";
    
    if( this.roles["core.create"] === true || this.roles["core.edit"] === true ){
        fila += "       <td align='center' style='vertical-align: middle; width: 50px;'>";
        ...
        fila += "       <td align='center' style='vertical-align: middle; width: 50px;'> <a class='delOI'> Eliminar </a> </td>";
        
    }else{
        fila += "       <td align='center' style='vertical-align: middle; width: 50px;'> Editar </td>";
        fila += "       <td align='center' style='vertical-align: middle; width: 50px;'> Eliminar </td>";
    }

...
if ( JFactory::getUser()->guest ) {
    ...
    $app->redirect();
} else if ( !JFactory::getUser()->authorise( 'core.admin', 'com_indicadores' ) ){
...
//  Require helper file
JLoader::register( 'IndicadoresHelper', JPATH_ADMINISTRATOR . DS . 'components' . DS . 'com_indicadores' . DS . 'helpers' . DS . 'indicadores.php' );

// Get an instance of the controller prefixed by Indicadores
$controller = JController::getInstance( 'Indicadores' );

 ...
 */
class adminmapasViewEcoraemapasfrontend extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo Mapa', 'ecoraemapa.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'ecoraemapa.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'ecoraemapas.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'ecoraemapas.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_ADMINMAPAS_ECORAEMAPA_ERROR_UNACCEPTABLE');
    }
}
 ...
 * 
 */
class MantenimientoTableItemsAgd extends JTable
{
    /**
    * Constructor
    *
    ...
    */
    ...
    public function deleteLogicalItem( $idEstructura )
    {
        try {
            ...
            $log = &JLog::getInstance('com_mantenimiento.tables.itemsagd.log.php');
     ...
     * @param type $idPadre                 Id del item owner
     * @return type
     */
    public function getItemsByEtr( $idEstructura, $idPadre = 0 )
    {
        try {
            $db = & JFactory::getDBO();
            $query = $db->getQuery(TRUE);
            ...
            $query->where("i.intIdItem_padre_it = {$idPadre}");

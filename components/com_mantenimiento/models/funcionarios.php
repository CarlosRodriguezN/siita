 ...
 */
class mantenimientoModelFuncionarios extends JModelList {
    ...
    public function __construct($config = array()) {
        if (empty($config['filter_fields'])) {
            ...
            $config['filter_fields'] = array('intCodigo_fnc',
                                            'strApellido_fnc',
                                            'strNombre_fnc',
                                            'strCorreoelec_fnc',
                                            'strTelefono_fnc',
    ...
    public function getItems() {
        ...
        foreach ($items as &$item) {
            $item->url = JRoute::_('index.php?option=com_mantenimiento&amp;task=funcionario.edit&amp;intCodigo_fnc=' . $item->intCodigo_fnc);
        }
    ...
    public function getListQuery() {
        ...
        $query->select('    fun.intCodigo_fnc, 
                            fun.strApellido_fnc ,
                            fun.strNombre_fnc ,
                            fun.strCorreoelec_fnc ,
                            fun.strTelefono_fnc ,
                            fun.strCi_fnc,
                            fun.published,
                            u.name');
        $query->from('#__gen_funcionario as fun');
       ...
       //
        ...
        if (!empty($search)) {
            ...
            $field_searches = " fun.strDescripcion_ag LIKE '" . $search . "' OR"
                            . " fun.vigencia LIKE '" . $search . "'";

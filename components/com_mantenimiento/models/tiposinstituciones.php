...
class mantenimientoModelTiposInstituciones extends JModelList
{
    public function __construct( $config = array() ) 
    {
        if( empty( $config['filter_fields'] ) ){
            ...
            $config['filter_fields'] = array(   'intCodigoTipo_ins', 
                                                'strDescripcionTipo_ins'
                                                 );
        }
    ...
    public function getItems()
    {
        ...
        foreach( $items as &$item ){
            $item->url = JRoute::_('index.php?option=com_mantenimiento&amp;task=tipoinstitucion.edit&amp;id='. $item->intCodigoTipo_ins );
        }
    ...
    public function getListQuery()
    {
        ...
        $query->select( '   ti.intCodigoTipo_ins,
        ...
        if( !empty ( $search ) ){
            ...
            $field_searches = " ti.strDescripcionTipo_ins LIKE '". $search ."' OR"
                            . " ti.intCodigoTipo_ins LIKE '". $search ."'";

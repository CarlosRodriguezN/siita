 ...
 * Vista Fase
 */
class MantenimientoViewTipoVariable extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'save', 'Guardar', 'tipovariable.save', false );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'cancel', 'Cancelar', 'tipovariable.cancel', false );

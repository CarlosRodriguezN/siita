 ...
 */
class MantenimientoViewTpoPlan extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'tpoplan.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'tpoplan.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/tpoplan/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_TIPO_PLAN_ERROR_UNACCEPTABLE');
    }

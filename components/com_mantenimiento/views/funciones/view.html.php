 ...
 */
class MantenimientoViewFunciones extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'funcion.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'funcion.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'funciones.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'funciones.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_FUNCIONES_ERROR_UNACCEPTABLE');
    }
}
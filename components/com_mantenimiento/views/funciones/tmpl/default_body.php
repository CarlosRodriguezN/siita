...
<?php foreach($this->items as $i => $item): ?>
	<tr class="row<?php echo $i % 2; ?>">
            <td>
                ...
                <?php echo JHtml::_( 'grid.id', $i, $item->intCodigofuncion ); ?>
            </td>
            
            <td>
                <?php echo ucwords( $item->strDescripcion_funcion ); ?>
            </td>
            
            <td class="center">
                <!-- Muestra la opcion para publicar y despublicar -->
                <?php echo JHtml::_( 'jgrid.published', $item->published, $i, 'funciones.', true, 'cb' ); ?>
            </td>
	</tr>
<?php endforeach;?>

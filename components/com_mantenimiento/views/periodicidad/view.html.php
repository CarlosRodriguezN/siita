 ...
 */
class MantenimientoViewPeriodicidad extends JView {
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/periodicidad/assets/reglas.js' );
        
        JText::script('COM_MANTENIMIENTO_PERIODICIDAD_ERROR_UNACCEPTABLE');
    }

 ...
 */
class MantenimientoViewClasesBeneficiarios extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'clasebeneficiario.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'clasebeneficiario.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'clasesbeneficiarios.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'clasesbeneficiarios.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_CLASESBENEFICIARIOS_ERROR_UNACCEPTABLE');
    }
}
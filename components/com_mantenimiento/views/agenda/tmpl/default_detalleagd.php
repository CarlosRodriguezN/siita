...
<div class="width-60 fltlft">
    <fieldset class="adminform">
        <legend> <?php echo JText::_('COM_MANTENIMIENTO_FIELD_AGD_DETALLES_LABEL') ?> </legend>
        <div class="fltrt">
        ...
        <table id="tbLstDetalles" width="100%" class="tablesorter" cellspacing="1">
            <thead>
                <tr>
                    <th align="center"><?php echo JText::_( 'COM_MANTENIMIENTO_FIELD_AGD_DETALLE_CAMPO_LABEL' ) ?></th>
                    <th align="center"><?php echo JText::_( 'COM_MANTENIMIENTO_FIELD_AGD_DETALLE_VALOR_LABEL' ) ?></th>
        ...
        <div id="srDtll" align="center" class="hide"> <p> <?php echo JText::_( 'COM_MANTENIMIENTO_SIN_REGISTROS' ); ?> </p> </div>
    </fieldset>
</div>

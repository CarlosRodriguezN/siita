 ...
 */
class MantenimientoViewDependencia extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'dependencia.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'dependencia.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/dependencia/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_DEPENDENCIA_ERROR_UNACCEPTABLE');
    }

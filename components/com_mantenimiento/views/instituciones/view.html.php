 ...
 */
class MantenimientoViewInstituciones extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'institucion.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'institucion.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'instituciones.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'instituciones.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_INSTITUCIONES_ERROR_UNACCEPTABLE');
    }
}
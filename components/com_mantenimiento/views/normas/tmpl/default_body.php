...
<?php foreach($this->items as $i => $item): ?>
	<tr class="row<?php echo $i % 2; ?>">
            <td>
                ...
                <?php echo JHtml::_( 'grid.id', $i, $item->intCodigoNorma ); ?>
            </td>
            
            <td>
                <?php echo ucwords( $item->strDescripcion_norma ); ?>
            </td>
            
            <td class="center">
                <!-- Muestra la opcion para publicar y despublicar -->
                <?php echo JHtml::_( 'jgrid.published', $item->published, $i, 'normas.', true, 'cb' ); ?>
            </td>
	</tr>
<?php endforeach;?>

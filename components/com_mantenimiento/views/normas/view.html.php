 ...
 */
class MantenimientoViewNormas extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'norma.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'norma.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'normas.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'normas.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_NORMAS_ERROR_UNACCEPTABLE');
    }
}
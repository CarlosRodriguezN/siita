 ...
 */
class MantenimientoViewUnidadesMedidas extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'unidadmedida.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'unidadmedida.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'unidadesmedidas.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'unidadesmedidas.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_UNIDADESMEDIDAS_ERROR_UNACCEPTABLE');
    }
}
 ...
 */
class MantenimientoViewTposPlan extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'tpoplan.add', false );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_TIPOS_PLAN_ERROR_UNACCEPTABLE');
    }
}
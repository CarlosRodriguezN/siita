 ...
 */
class MantenimientoViewEstados extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'estado.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'estado.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'estados.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'estados.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_ESTADOS_ERROR_UNACCEPTABLE');
    }
}
...
<div id="content-box">
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-contact">
                <h2> <?php echo JText::_( 'COM_MANTENIMIENTO_ADMINISTRACION_MEDIOSVERIFICACIONES' ) ?> </h2>
            </div>
        </div>
    </div>
    ...
    <div id="element-box">
        <div class="m">
            <form action="<?php echo JRoute::_( 'index.php?option=com_mantenimiento&amp;view=mediosverificaciones' ); ?>" method="post" name="adminForm" id="adminForm">

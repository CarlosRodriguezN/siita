 ...
 */
class MantenimientoViewMediosVerificaciones extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'medioverificacion.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'medioverificacion.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'mediosverificaciones.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'mediosverificaciones.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_MEDIOSVERIFICACIONES_ERROR_UNACCEPTABLE');
    }
}
 ...
 */
class MantenimientoViewFuncionarios extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'funcionario.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'funcionario.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'funcionarios.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'funcionarios.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_FUNCIONARIOS_ERROR_UNACCEPTABLE');
    }
}
...
class MantenimientoViewBeneficiario extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'beneficiario.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'beneficiario.cancel', false);
    ...
    protected function setDocument() {
        ...
        JText::script('COM_MANTENIMIENTO_BENEFICIARIO_ERROR_UNACCEPTABLE');
    }

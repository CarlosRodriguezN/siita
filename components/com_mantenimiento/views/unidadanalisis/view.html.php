 ...
 */
class MantenimientoViewUnidadAnalisis extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'unidadanalisis.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'unidadanalisis.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/unidadanalisis/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_UNIDADANALISIS_ERROR_UNACCEPTABLE');
    }

 ...
 */
class MantenimientoViewTposObjsPlan extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'tpoobjplan.add', false );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_TIPOS_OBJETIVOS_PLAN_ERROR_UNACCEPTABLE');
    }
}
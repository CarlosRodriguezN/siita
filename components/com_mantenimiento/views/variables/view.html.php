 ...
 */
class MantenimientoViewVariables extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'variable.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'variable.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'variables.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'variables.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_VARIABLE_ERROR_UNACCEPTABLE');
    }
}
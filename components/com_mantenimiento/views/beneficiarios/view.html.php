 ...
 */
class MantenimientoViewBeneficiarios extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'beneficiario.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'beneficiario.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'beneficiarios.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'beneficiarios.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_BENEFICIARIOS_ERROR_UNACCEPTABLE');
    }
}
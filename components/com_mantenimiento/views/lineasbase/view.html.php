 ...
 */
class MantenimientoViewLineasBase extends JView
{
    /**
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/lineasbase/assets/Reglas.js' );
        
        JText::script('COM_MANTENIMIENTO_LINEAS_BASE_ERROR_UNACCEPTABLE');
    }
}
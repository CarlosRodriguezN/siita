 ...
 */
class MantenimientoViewFuncion extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'funcion.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'funcion.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/funcion/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_FUNCION_ERROR_UNACCEPTABLE');
    }

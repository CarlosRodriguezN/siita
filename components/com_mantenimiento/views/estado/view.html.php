 ...
 */
class MantenimientoViewEstado extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'estado.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'estado.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/estado/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_ESTADO_ERROR_UNACCEPTABLE');
    }

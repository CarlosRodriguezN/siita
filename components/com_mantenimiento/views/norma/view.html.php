 ...
 */
class MantenimientoViewNorma extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'norma.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'norma.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/norma/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_NORMA_ERROR_UNACCEPTABLE');
    }

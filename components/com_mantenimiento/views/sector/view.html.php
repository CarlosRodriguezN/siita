 ...
 */
class MantenimientoViewSector extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'sector.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'sector.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/sector/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_SECTOR_ERROR_UNACCEPTABLE');
    }

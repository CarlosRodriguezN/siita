 ...
 */
class MantenimientoViewMedioVerificacion extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'medioverificacion.save', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/medioverificacion/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_MEDIOVERIFICACION_ERROR_UNACCEPTABLE');
    }

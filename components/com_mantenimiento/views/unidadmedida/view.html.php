 ...
 */
class MantenimientoViewUnidadMedida extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'unidadmedida.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'unidadmedida.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/unidadmedida/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_UNIDADMEDIDA_ERROR_UNACCEPTABLE');
    }

 ...
 */
class MantenimientoViewSupuesto extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'supuesto.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'supuesto.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/supuesto/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_SUPUESTO_ERROR_UNACCEPTABLE');
    }

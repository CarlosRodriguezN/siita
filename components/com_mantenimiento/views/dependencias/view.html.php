 ...
 */
class MantenimientoViewDependencias extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'dependencia.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'dependencia.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'dependencias.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'dependencias.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_DEPENDENCIAS_ERROR_UNACCEPTABLE');
    }
}
 ...
 */
class MantenimientoViewTiposInstituciones extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'tipoinstitucion.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'tipoinstitucion.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'tiposinstituciones.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'tiposinstituciones.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_TIPOSINSTITUCIONES_ERROR_UNACCEPTABLE');
    }
}
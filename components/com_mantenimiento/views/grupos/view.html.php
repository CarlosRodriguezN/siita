 ...
 */
class MantenimientoViewGrupos extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'grupo.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'grupo.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'grupos.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'grupos.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_GRUPOS_ERROR_UNACCEPTABLE');
    }
}
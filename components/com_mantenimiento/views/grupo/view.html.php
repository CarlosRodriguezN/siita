 ...
 */
class MantenimientoViewGrupo extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'grupo.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'grupo.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/grupo/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_TIPOVARIABLE_ERROR_UNACCEPTABLE');
    }

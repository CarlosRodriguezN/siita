 ...
 */
class MantenimientoViewAgendas extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', JText::_('COM_MANTENIMIENTO_NUEVO'), 'agenda.add', false );
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/agendas/assets/Reglas.js' );

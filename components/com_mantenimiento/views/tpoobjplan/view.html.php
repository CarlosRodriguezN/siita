 ...
 */
class MantenimientoViewTpoObjPlan extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'tpoobjplan.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'tpoobjplan.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/tpoobjplan/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_TIPO_OBJETIVO_PLAN_ERROR_UNACCEPTABLE');
    }

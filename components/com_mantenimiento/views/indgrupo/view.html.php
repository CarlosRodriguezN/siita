 ...
 */
class MantenimientoViewIndGrupo extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'indgrupo.save', false);
        $bar->appendButton('Separator');
        
//        if( $this->item->intId_gpo != null ) {
//            $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'indgrupo.delete', false );
//        }

        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'indgrupo.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/indgrupo/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_IND_GRUPO_ERROR_UNACCEPTABLE');
    }

 ...
 */
class MantenimientoViewUnidadesAnalisis extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'unidadanalisis.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'unidadanalisis.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'unidadesanalisis.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'unidadesanalisis.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_UNIDADESANALISIS_ERROR_UNACCEPTABLE');
    }
}
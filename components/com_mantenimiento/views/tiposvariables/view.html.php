 ...
 */
class MantenimientoViewTiposVariables extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'tipovariable.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'tipovariable.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'tiposvariables.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'tiposvariables.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_TIPOSVARIABLES_ERROR_UNACCEPTABLE');
    }
}
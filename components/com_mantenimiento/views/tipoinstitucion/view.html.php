 ...
 */
class MantenimientoViewTipoInstitucion extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'tipoinstitucion.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'tipoinstitucion.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/tipoinstitucion/assets/reglas.js' );
        
        JText::script('COM_MANTENIMIENTO_TIPOINSTITUCION_ERROR_UNACCEPTABLE');
    }

 ...
 */
class MantenimientoViewIndicadores extends JView
{
    /**
    ...
    */
    ...
    function display($tpl = null) 
    {
        ...
        //  la cual internamente accede al "MantenimientoModelIndicadores" y ejecuta el metodo "getItems"
        ...
        //  "MantenimientoModelIndicadores" del modelo
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', JText::_('COM_MANTENIMIENTO_NUEVO'), 'indicador.add', false );
        $bar->appendButton( 'Standard', 'cancel', JText::_('COM_MANTENIMIENTO_CANCELAR'), 'indicador.cancel', false );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_AGENDAS_ERROR_UNACCEPTABLE');
    }
}
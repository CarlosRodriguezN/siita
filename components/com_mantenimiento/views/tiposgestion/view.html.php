 ...
 */
class MantenimientoViewTiposGestion extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'tipogestion.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'tipogestion.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'tiposgestion.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'tiposgestion.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_TIPOSGESTION_ERROR_UNACCEPTABLE');
    }
}
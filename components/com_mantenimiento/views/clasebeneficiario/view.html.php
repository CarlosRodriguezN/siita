 ...
 */
class MantenimientoViewClaseBeneficiario extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'clasebeneficiario.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'clasebeneficiario.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/clasebeneficiario/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_CLASEBENEFICIARIO_ERROR_UNACCEPTABLE');
    }

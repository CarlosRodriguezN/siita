 ...
 */
class MantenimientoViewEnfoques extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', JText::_('COM_MANTENIMIENTO_NUEVO'), 'enfoque.add', false );
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/enfoques/assets/Reglas.js' );
        
        JText::script('COM_MANTENIMIENTO_ENFOQUES_ERROR_UNACCEPTABLE');
    }
}
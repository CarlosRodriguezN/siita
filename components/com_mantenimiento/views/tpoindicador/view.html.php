...
/**
 * Vista de Ingreso/Edicion de un tipo de indicador
 */
class MantenimientoViewTpoIndicador extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', JText::_('COM_MANTENIMIENTO_GUARDAR'), 'tpoindicador.save', false);
        
        if ($this->item->intCodigoTipo_ind != 0) {
            $bar->appendButton('Standard', 'delete', JText::_('COM_MANTENIMIENTO_ELIMINAR'), 'tpoindicador.delete', false);
        }
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/lineabase/assets/reglas.js' );

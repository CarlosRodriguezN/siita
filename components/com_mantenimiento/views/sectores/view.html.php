 ...
 */
class MantenimientoViewSectores extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'sector.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'sector.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'sectores.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'sectores.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_SECTORES_ERROR_UNACCEPTABLE');
    }
}
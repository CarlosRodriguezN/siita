 ...
 */
class MantenimientoViewEnfoque extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save',JText::_('COM_MANTENIMIENTO_GUARDAR'), 'enfoque.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', JText::_('COM_MANTENIMIENTO_CANCELAR'), 'enfoque.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/enfoque/assets/Reglas.js' );

        JText::script('COM_MANTENIMIENTO_ENFOQUE_ERROR_UNACCEPTABLE');
    }

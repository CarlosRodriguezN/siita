 ...
 */
class MantenimientoViewCategoria extends JView {
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/categoria/assets/reglas.js' );
        
        JText::script('COM_MANTENIMIENTO_CATAGORIA_ERROR_UNACCEPTABLE');
    }

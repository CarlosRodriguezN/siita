 ...
 */
class MantenimientoViewSubSectores extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'subsector.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'subsector.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'subsectores.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'subsectores.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_SUBSECTORES_ERROR_UNACCEPTABLE');
    }
}
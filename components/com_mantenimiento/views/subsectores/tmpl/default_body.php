...
<?php foreach($this->items as $i => $item): ?>
	<tr class="row<?php echo $i % 2; ?>">
            <td>
                ...
                <?php echo JHtml::_( 'grid.id', $i, $item->inpCodigo_subsec ); ?>
            </td>
            
            <td>
                <?php echo ucwords( $item->strDescripcion_subsec ); ?>
            </td>
            ...
            <td class="center">
                ...
                <?php echo JHtml::_( 'jgrid.published', $item->published, $i, 'subsectores.', true, 'cb' ); ?>
            </td>
	</tr>
<?php endforeach;?>

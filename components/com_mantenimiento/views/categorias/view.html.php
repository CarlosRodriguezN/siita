 ...
 */
class MantenimientoViewCategorias extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'categoria.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'categoria.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'categorias.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'categorias.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_MANTENIMIENTO_CATEGORIA_ERROR_UNACCEPTABLE');
    }
}
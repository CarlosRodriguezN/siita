 ...
 */
class MantenimientoViewInstitucion extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'institucion.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'institucion.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/institucion/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_INSTITUCION_ERROR_UNACCEPTABLE');
    }

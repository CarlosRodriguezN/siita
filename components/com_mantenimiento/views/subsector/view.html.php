 ...
 */
class MantenimientoViewSubsector extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'subsector.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'subsector.cancel', false);
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/subsector/assets/reglas.js' );

        JText::script('COM_MANTENIMIENTO_SUBSECTOR_ERROR_UNACCEPTABLE');
    }

...
GestionIndicador.prototype.addFilaIndicadorGAP = function( dtaIndGap, ban )
{
    ...
    fila += "       <td align='center'>"
            + "         <a id='aim-gap-" + dtaIndGap.idRegGap + "' onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndGap.gapMasculino.idIndicador +"&tpo=m&tpoIndicador=gap&idRegIndicador="+ dtaIndGap.idRegGap +"&tmpl=component&task=preview\", {size:{x: "+ POPUP_ANCHO +", y: "+ POPUP_ALTO +" }, handler:\"iframe\"} );'>"
    ...
    fila += "       <td align='center'>"
            + "         <a onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndGap.gapFemenino.idIndicador +"&tpo=f&tpoIndicador=gap&idRegIndicador="+ dtaIndGap.idRegGap +"&tmpl=component&task=preview\", {size:{x:"+ POPUP_ANCHO +", y: "+ POPUP_ALTO +"}, handler:\"iframe\"} );'>"        
    fila += "               <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"' >";
            + "         </a>"
            + "     </td>";
    ...
    fila += "       <td align='center'>"
            + "         <a onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndGap.gapTotal.idIndicador +"&tpo=t&tpoIndicador=gap&idRegIndicador="+ dtaIndGap.idRegGap +"&tmpl=component&task=preview\", {size:{x:"+ POPUP_ANCHO +", y: "+ POPUP_ALTO +"}, handler:\"iframe\"} );'>"
    fila += "               <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"' >";
            + "         </a>"
            + "     </td>";
...
GestionIndicador.prototype.addFilaIndEIgualdad = function( tpoEnfoque, EIgualdad, dtaIndEIgualdad, ban )
{
    ...
    fila += "       <td align='center'>"
            + "         <a onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndEIgualdad.eiMasculino.idIndicador +"&tpo=m&tpoIndicador=ei&idRegIndicador="+ dtaIndEIgualdad.idRegEI +"&tmpl=component&task=preview\", {size:{x:"+ POPUP_ANCHO +", y: "+ POPUP_ALTO +"}, handler:\"iframe\"} );'>";
    fila += "               <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"'>"
            + "         </a>"
            + "     </td>";
    ...
    fila += "       <td align='center'>"
            + "         <a onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndEIgualdad.eiFemenino.idIndicador +"&tpo=f&tpoIndicador=ei&idRegIndicador="+ dtaIndEIgualdad.idRegEI +"&tmpl=component&task=preview\", {size:{x:"+ POPUP_ANCHO +", y: "+ POPUP_ALTO +"}, handler:\"iframe\"} );'>";
    fila += "               <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"' >"
            + "         </a>"
            + "     </td>";
    ...
    fila += "       <td align='center'>"
            + "         <a onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndEIgualdad.eiTotal.idIndicador +"&tpo=t&tpoIndicador=ei&idRegIndicador="+ dtaIndEIgualdad.idRegEI +"&tmpl=component&task=preview\", {size:{x:"+ POPUP_ANCHO +", y: "+ POPUP_ALTO +"}, handler:\"iframe\"} );'>";
    fila += "               <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"' >"
            + "         </a>"
            + "     </td>";
...
GestionIndicador.prototype.addFilaIndEEcorae = function( EEcorae, dtaIndEEcorae, ban )
{
    ...
    fila += "       <td align='center'>"
            + "         <a onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndEEcorae.eeMasculino.idIndicador +"&tpo=m&tpoIndicador=ee&idRegIndicador="+ dtaIndEEcorae.idRegEE +"&tmpl=component&task=preview\", {size:{x:"+ POPUP_ANCHO +", y: "+ POPUP_ALTO +"}, handler:\"iframe\"} );'>";
    fila += "               <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"' >"
            + "         </a>"
            + "     </td>";
    ...
    fila += "       <td align='center'>"
            + "         <a onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndEEcorae.eeFemenino.idIndicador +"&tpo=f&tpoIndicador=ee&idRegIndicador="+ dtaIndEEcorae.idRegEE +"&tmpl=component&task=preview\", {size:{x:"+ POPUP_ANCHO +", y: "+ POPUP_ALTO +"}, handler:\"iframe\"} );'>";
    fila += "               <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"' >"
            + "         </a>"
            + "     </td>";
    ...
    fila += "       <td align='center'>"
            + "         <a onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndEEcorae.eeTotal.idIndicador +"&tpo=t&tpoIndicador=ee&idRegIndicador="+ dtaIndEEcorae.idRegEE +"&tmpl=component&task=preview\", {size:{x:"+ POPUP_ANCHO +", y: "+ POPUP_ALTO +"}, handler:\"iframe\"} );'>";
    fila += "               <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"' >"
            + "         </a>"
            + "     </td>";
...
GestionIndicador.prototype.addFilaOtroIndicador = function( objOtroInd, ban )
{
    ...
    fila += "       <td align='center'>";
    fila += "           <a onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=tableu&layout=edit&idIndicador="+ objOtroInd.idIndicador +"&tmpl=component&task=preview\", {size:{x: "+ COM_CONTRATOS_POPUP_TABLEU_ANCHO +", y: "+ COM_CONTRATOS_POPUP_TABLEU_ALTO +"}, handler:\"iframe\"} );'> "+ COM_CONTRATOS_POPUP_TABLEU +" </a>";
    fila += "       </td>";

    fila += "       <td align='center'>";
    fila += "           <a onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=0&tpoIndicador=oi&idRegIndicador="+ objOtroInd.idRegIndicador +"&tmpl=component&task=preview\", {size:{x: "+ POPUP_ANCHO +", y: "+ POPUP_ALTO +"}, handler:\"iframe\"} );'> Editar </a>";
    fila += "       </td>";
...
GestionIndicador.prototype.getDtaSemaforizacion = function( banIndicador ){
    ...
    switch( banIndicador ){
        //  Rojo
        case 0: 
            dtaSemaforizacion["imgAtributo"] = COM_CONTRATOS_RG_ATRIBUTO;
            dtaSemaforizacion["msgAtributo"] = COM_CONTRATOS_TITLE_RG_ATRIBUTO;
        break;

        //  Amarillo
        case 1: 
            dtaSemaforizacion["imgAtributo"]= COM_CONTRATOS_AM_ATRIBUTO;
            dtaSemaforizacion["msgAtributo"]= COM_CONTRATOS_TITLE_AM_ATRIBUTO;
            dtaSemaforizacion["msgStyle"]   = COM_CONTRATOS_STYLE_AM;

        break;

        //  Verde
        case 2: 
            dtaSemaforizacion["imgAtributo"]= COM_CONTRATOS_VD_ATRIBUTO;
            dtaSemaforizacion["msgAtributo"]= COM_CONTRATOS_TITLE_VD_ATRIBUTO;
        break;
    }

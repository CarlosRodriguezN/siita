...
PlanOperativo.prototype.addFilaPlan = function( ban )
{
    ...
    fila += "   <td align='center' >"+ this.descripcionPln +"</td>"
            + " <td align='center' width='25px' >"+ this.getAlineacion() +"</td>"
            + " <td align='center' width='25px' >"+ this.getAcciones() +"</td>"
            + " <td align='center' width='25px' >"+ this.getIndicadores() +"</td>";
...
PlanOperativo.prototype.getIndicadores = function()
{
    ...
    if( this.planObjetivo.lstIndicadores.length ){
        ds = this.getDtaSemaforizacionIndicador( 1 );
    }else{

jQuery(document).ready(function() {
    ...
    function makeFila(objetivo, op)
    {
        ...
        fila += '        <a id="AL' + idReg + '" onclick="SqueezeBox.fromElement( \'index.php?option=com_alineacion&tpoEntidad=2&view=operativa&layout=edit&registroObj=' + idReg + '&tmpl=component&task=preview\', {size:{x:'+ POPUP_ANCHO +',y:'+ POPUP_ALTO +'}, handler:\'iframe\'} );">';
        ...
        fila += '     <td align="center" width="15" >';
        fila += '        <a id="ACC' + idReg + '" onclick="SqueezeBox.fromElement( \'index.php?option=com_pei&view=plnaccion&layout=edit&registroObj=' + idReg + '&tmpl=component&task=preview\', {size:{x:'+ POPUP_ANCHO +',y:'+ POPUP_ALTO +'}, handler:\'iframe\'} );">';
        fila += '           <img src="' + ds["imgAtributo"] + '" title="' + ds["msgAtributo"] + '" style="' + ds["msgStyle"] + '">';
        fila += '        </a>';
        fila += '     </td>';
        ...
        fila += '     <td align="center" width="15" >';
        fila += '        <a onclick="SqueezeBox.fromElement( \'index.php?option=com_indicadores&view=indicadores&layout=edit&tpoIndicador=contrato&idRegObjetivo=' + idReg + '&tmpl=component&task=preview\', {size:{x:'+ POPUP_IND_ANCHO +',y:'+ POPUP_IND_ALTO +'}, handler:\'iframe\'} );">';
        ...
        if( roles["core.create"] === true || roles["core.edit"] === true ){
            ...
            fila += '     <td align="center" width="15" style="vertical-align: middle;"> Editar </td > ';
            fila += '     <td align="center" width="15" style="vertical-align: middle;"> Eliminar </td>';
        }
    ...
    function getDtaSemaforizacionAlineacion(banIndicador)
    {
        ...
        switch (banIndicador) {
            //  Rojo
            case 0:
                dtaSemaforizacion["imgAtributo"] = COM_CONTRATOS_RG_SIN_ALINEACION;
                dtaSemaforizacion["msgAtributo"] = COM_CONTRATOS_TITLE_RG_SIN_ALINEACION;
                break;

                //  Verde
            case 3:
                dtaSemaforizacion["imgAtributo"] = COM_CONTRATOS_VD_ALINEACION;
                dtaSemaforizacion["msgAtributo"] = COM_CONTRATOS_TITLE_VD_ALINEACION;
                break;
        }
...
function getDtaSemaforizacionAccion(banIndicador)
{
    ...
    switch (banIndicador) {
        //  Rojo
        case 0:
            dtaSemaforizacion["imgAtributo"] = COM_CONTRATOS_RG_SIN_ACCION;
            dtaSemaforizacion["msgAtributo"] = COM_CONTRATOS_TITLE_RG_SIN_ACCION;
            break;

            //  Verde
        case 3:
            dtaSemaforizacion["imgAtributo"] = COM_CONTRATOS_RG_ACCION;
            dtaSemaforizacion["msgAtributo"] = COM_CONTRATOS_TITLE_RG_ACCION;
            break;
    }

...
jQuery(document).ready(function() {
     ...
     * 
     */
    if ( contratos.lstFacturas.length > 0 ) {
        reloadFacturaTable();
    }
    ...
    jQuery('#addFactura').click(function() {
        ...
        data["monto"] = jQuery("#jform_dcmMonto_fac").val().substr(2).replace(",",'');
    ...
    jQuery('.editFactura').live("click", function() {
        ...
        jQuery('#jform_dcmMonto_fac' ).attr( 'value', formatNumber( data.monto, '$' ) );
    ...
    jQuery("#addFacturaTable").click(function() {
        ...
        jQuery('#ieavFactura').css("display", "none");
        jQuery('#editFacturaForm').css("display", "block");
        jQuery('#addPlanillaFacturaFactura').css("display", "none");
    });
    /**
...
function clCmpFactura() {
    ...
    resetValidateForm( "#editFacturaForm" );

                        ...
                        <td align="center">
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr align="center">
                                    ...
                                    <td>
                                        <a id="ECO0AI" href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=1&tpoIndicador=eco&ent=contrato&idRegIndicador=0&tpo=fijo&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                                            <img src="<?php echo JText::_( 'COM_CONTRATOS_RG_ATRIBUTO' ); ?>" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_RG_ATRIBUTO' ) ?>" >
                                        </a> 
                                    </td>
                        ...
                        <td align="center">
                            ...
                            <table cellpadding="0"  cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <a id="ECO1AI" href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=2&tpoIndicador=eco&ent=contrato&idRegIndicador=1&tpo=fijo&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                                            <img src="<?php echo JText::_( 'COM_CONTRATOS_RG_ATRIBUTO' ); ?>" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_RG_ATRIBUTO' ) ?>" >
                                        </a> 
                                    </td>
                        ...
                        <td align="center">
                            ...
                            <table cellpadding="0"  cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <a id="ECO2AI" href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=3&tpoIndicador=eco&ent=contrato&idRegIndicador=2&tpo=fijo&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                                            <img src="<?php echo JText::_( 'COM_CONTRATOS_RG_ATRIBUTO' ); ?>" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_RG_ATRIBUTO' ) ?>" >
                                        </a>
                                    </td>
                        ...
                        <td align="center"> 
                            ...
                            <table cellpadding="0"  cellspacing="0">
                                <tr>
                                    ...
                                    <!-- TIR - Economico - Atributos de un Indicador -->
                                    <td>
                                        <a id="FIN0AI" href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=4&tpoIndicador=fin&ent=contrato&idRegIndicador=0&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                                            <img src="<?php echo JText::_( 'COM_CONTRATOS_RG_ATRIBUTO' ); ?>" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_RG_ATRIBUTO' ) ?>" >
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <td align="center">
                            ...
                            <table cellpadding="0"  cellspacing="0">
                                <tr>
                                    ...
                                    <!-- TIR - Economico - Atributos de un Indicador -->
                                    <td>
                                        <a id="FIN1AI" href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=5&tpoIndicador=fin&ent=contrato&idRegIndicador=1&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                                            <img src="<?php echo JText::_( 'COM_CONTRATOS_RG_ATRIBUTO' ); ?>" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_RG_ATRIBUTO' ) ?>" >
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <td align="center">
                            ...
                            <table cellpadding="0"  cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a id="FIN2AI" href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=6&tpoIndicador=fin&ent=contrato&idRegIndicador=2&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                                            <img src="<?php echo JText::_( 'COM_CONTRATOS_RG_ATRIBUTO' ); ?>" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_RG_ATRIBUTO' ) ?>" >
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <td align="center">
                            ...
                            <table cellpadding="0"  cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <a id="BD0AI" href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=7&tpo=m&tpoIndicador=bd&ent=contrato&idRegIndicador=0&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                                            <img src="<?php echo JText::_( 'COM_CONTRATOS_RG_ATRIBUTO' ); ?>" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_RG_ATRIBUTO' ) ?>" >
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <td align="center">
                            ...
                            <table cellpadding="0"  cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <a id="BD1AI" href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=8&tpo=f&tpoIndicador=bd&ent=contrato&idRegIndicador=1&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                                            <img src="<?php echo JText::_( 'COM_CONTRATOS_RG_ATRIBUTO' ); ?>" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_RG_ATRIBUTO' ) ?>" >
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <td align="center">
                            ...
                            <table cellpadding="0"  cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <a id="BD2AI" href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=9&tpo=t&tpoIndicador=bd&ent=contrato&idRegIndicador=2&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                                            <img src="<?php echo JText::_( 'COM_CONTRATOS_RG_ATRIBUTO' ); ?>" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_RG_ATRIBUTO' ) ?>" >
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <td align="center">
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <a id="BI0AI" href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=10&tpo=m&tpoIndicador=bi&ent=contrato&idRegIndicador=0&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                                            <img src="<?php echo JText::_( 'COM_CONTRATOS_RG_ATRIBUTO' ); ?>" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_RG_ATRIBUTO' ) ?>" >
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <td align="center"> 
                            ...
                            <table cellpadding="0"  cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <a id="BI1AI" href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=11&tpo=f&tpoIndicador=bi&ent=contrato&idRegIndicador=1&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                                            <img src="<?php echo JText::_( 'COM_CONTRATOS_RG_ATRIBUTO' ); ?>" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_RG_ATRIBUTO' ) ?>" >
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <td align="center">
                            ...
                            <table cellpadding="0"  cellspacing="0">
                                <tr>
                                    ...
                                    <td>
                                        <a id="BI2AI" href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=12&tpo=t&tpoIndicador=bi&ent=contrato&idRegIndicador=2&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                                            <img src="<?php echo JText::_( 'COM_CONTRATOS_RG_ATRIBUTO' ); ?>" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_RG_ATRIBUTO' ) ?>" >
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <tr>
                            <td align="right" colspan="3"> 
                                <?php if( $this->canDo->get( 'core.create' ) ): ?>
                                    <input id="btnAddGAP" type="button" value="<?php echo JText::_('COM_CONTRATOS_BT_INDICADOR_GAP_ADDEI') ?>"> 
                                <?php endIf; ?>
        ...
        <div id="otrosInd" class="m">
            ...
            <div class="width-100">
                <fieldset class="adminform">
                    ...
                    <div class="clr"></div>
                    <?php if( $this->canDo->get( 'core.create' ) ): ?>
                        <a href="index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador=0&tpoIndicador=oi&ent=contrato&idRegIndicador=-1&tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ANCHO' ); ?>, y: <?php echo JText::_( 'COM_CONTRATOS_POPUP_ALTO' ); ?>}}"> 
                            <div id="NI2AI" title='<?php echo JText::_('BTN_AGREGAR_TITLE') ?>'> 
                                <label style="min-width: 0px"> <?php echo JText::_('BTN_AGREGAR') ?> </label>
                                <img src="<?php echo JText::_( 'COM_CONTRATOS_VD_ATRIBUTO' ) ?>" id="ai-bd-0" title="<?php echo JText::_( 'COM_CONTRATOS_TITLE_VD_ATRIBUTO' ) ?>" >
                            </div>
                        </a>
                    <?php endIf; ?>
                    <div class="clr"></div>
                    ...
                    <table id="lstOtrosInd" width="100%" class="tablesorter" cellspacing="1">
                        <thead>
                            <tr>
                                <th align="center"> <?php echo JText::_('COM_CONTRATOS_FIELD_INDICADOR_ESTADO_TITLE') ?> </th>
                                ...
                                <th colspan="3" align="center"> <?php echo JText::_('COM_CONTRATOS_FIELD_INDICADOR_ACCIONOTROIND_TITLE') ?> </th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>

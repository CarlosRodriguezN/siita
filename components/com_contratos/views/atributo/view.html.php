 ...
 */
class contratosViewAtributo extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'atributo.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'atributo.cancel', false);
    ...
    protected function setDocument() {
        ...
        JText::script('COM_CONTRATOA_ATRIBUTO_ERROR_UNACCEPTABLE');
    }

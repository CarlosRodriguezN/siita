 ...
 */
class contratosViewFiscalizadores extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo Fiscalizador', 'fiscalizador.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'fiscalizador.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'fiscalizador.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'fiscalizadores.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'fiscalizadores.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_FISCALIZADORES_ERROR_UNACCEPTABLE');
    }
}
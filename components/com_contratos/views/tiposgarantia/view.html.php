 ...
 */
class contratosViewTiposGarantia extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'tipogarantia.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'tipogarantia.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'tipogarantia.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'tiposgarantia.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'tiposgarantia.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_TIPOSGARANTIA_ERROR_UNACCEPTABLE');
    }
}
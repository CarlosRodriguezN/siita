 ...
 */
class contratosViewContratistas extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo Contrato', 'contratista.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'contratista.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'contratista.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'contratistas.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'contratistas.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_CONTRATISTAS_ERROR_UNACCEPTABLE');
    }
}
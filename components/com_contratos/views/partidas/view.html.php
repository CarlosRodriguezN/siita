 ...
 */
class contratosViewPartidas extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo Atributo', 'partida.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'partida.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'partida.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'partidas.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'partidas.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_PARTIDAS_ERROR_UNACCEPTABLE');
    }
}
 ...
 */
class contratosViewGarantias extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nueva Garantia', 'garantia.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'garantia.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'garantia.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'garantias.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'garantias.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_GARANTIAS_ERROR_UNACCEPTABLE');
    }
}
 ...
 */
class contratosViewAtributos extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo Atributo', 'atributo.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'atributo.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'atributo.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'atributos.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'atributos.unpublish', true );

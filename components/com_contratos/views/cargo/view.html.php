 ...
 */
class contratosViewCargo extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'cargo.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'cargo.cancel', false);
    ...
    protected function setDocument() {
        ...
        JText::script('COM_CONTRATOA_CARGO_ERROR_UNACCEPTABLE');
    }

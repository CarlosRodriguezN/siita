 ...
 */
class contratosViewFiscalizador extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'fiscalizador.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'fiscalizador.cancel', false);
    ...
    protected function setDocument() {
        ...
        JText::script('COM_CONTRATO_FISCALIZADOR_ERROR_UNACCEPTABLE');
    }

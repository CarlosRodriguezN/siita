 ...
 */
class contratosViewEstadoGarantia extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'estadogarantia.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'estadogarantia.cancel', false);
    ...
    protected function setDocument() {
        ...
        JText::script('COM_CONTRATOA_ESTADOGARANTIA_ERROR_UNACCEPTABLE');
    }

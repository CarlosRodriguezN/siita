 ...
 */
class contratosViewMultas extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'multa.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'multa.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'multa.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'multas.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'multas.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_MULTAS_ERROR_UNACCEPTABLE');
    }
}
 ...
 */
class contratosViewEstadosGarantia extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'estadogarantia.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'estadogarantia.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'estadogarantia.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'estadosgarantia.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'estadosgarantia.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_ESTADOSGARANTIA_ERROR_UNACCEPTABLE');
    }
}
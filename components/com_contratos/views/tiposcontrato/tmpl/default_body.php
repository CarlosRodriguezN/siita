...
<?php foreach ($this->items as $i => $item): ?>
    <tr class="row<?php echo $i % 2; ?>">
        <td>
            ...
            <?php echo JHtml::_('grid.id', $i, $item->idtipoContrato); ?>
        </td>
        <td >
            <?php echo ucwords($item->codTipoContrato); ?>
        </td>
        <td >
        ...
        <td class = "center" style = "width: 50px;">
            ...
            <?php echo JHtml::_('jgrid.published', $item->published, $i, 'tipocontrato.', true, 'cb');
            ?>
        </td>   
    </tr>
<?php endforeach; ?>
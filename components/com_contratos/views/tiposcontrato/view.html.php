 ...
 */
class contratosViewTiposContrato extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'tipocontrato.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'tipocontrato.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'tipocontrato.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'tiposcontrato.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'tiposcontrato.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_TIPOSCONTRATO_ERROR_UNACCEPTABLE');
    }
}
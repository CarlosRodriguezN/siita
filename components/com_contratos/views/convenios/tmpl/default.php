...
<div id="toolbar-box">
    <div class="m">
        ...
        <div class="pagetitle icon-48-contact">
            <h2> <?php echo JText::_('COM_CONTRATOS_GESTION_CONTRATOS') ?> </h2>
        </div>
    </div>
</div>
...
<div id="element-box">
    <div class="m">
        <form action="<?php echo JRoute::_('index.php?option=com_contratos&amp;view=convenios'); ?>" method="post" name="adminForm" id="adminForm">

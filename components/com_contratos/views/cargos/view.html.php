 ...
 */
class contratosViewCargos extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo Cargo', 'cargo.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'cargo.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'cargo.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'cargos.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'cargos.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_CARGOS_ERROR_UNACCEPTABLE');
    }
}
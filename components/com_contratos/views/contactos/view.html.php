 ...
 */
class contratosViewContactos extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo Contacto', 'contacto.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'contacto.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'contacto.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'contactos.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'contactos.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_CONTACTOS_ERROR_UNACCEPTABLE');
    }
}
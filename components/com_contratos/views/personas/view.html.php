 ...
 */
class contratosViewPersonas extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nueva Persona', 'persona.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'persona.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'persona.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'personas.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'personas.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_PERSONAS_ERROR_UNACCEPTABLE');
    }
}
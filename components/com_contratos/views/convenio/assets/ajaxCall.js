...
jQuery(document).ready(function() {
    ...
    jQuery("#jform_intidPrograma").change(function() {
        jQuery('#jform_intIdSubrograma').html('Cargando...');
        jQuery.ajax({
            type: 'GET',
            url: path,
            dataType: 'JSON',
    ...
    jQuery("#jform_intIdSubrograma").change(function() {
        jQuery('#jform_intCodigo_pry').html("Cargando...");
        jQuery.ajax({
            type: 'GET',
            url: path,
            dataType: 'JSON',
     ...
     * 
     */
    jQuery("#jform_intIDProvincia_dpa").change(function(event) {
        jQuery("#jform_intIDCanton_dpa").val("Cargando...");
        jQuery("#jform_intIDParroquia_dpa").val("Cargando...");
        jQuery.ajax({
            type: 'GET',
            url: path,
            dataType: 'JSON',
            ...
            if (regUnidadTerritorial != 0) {
                ...
                if (data) {
                    recorrerCombo(jQuery("#jform_intIDCanton_dpa option"), data.idCanton);
                    jQuery("#jform_intIDCanton_dpa").trigger("change");
                }
     ...
     * carga de cantones.
     */
    jQuery("#jform_intIDCanton_dpa").change(function() {
        jQuery("#jform_intIDParroquia_dpa").val("Cargando...");
        jQuery.ajax({
            type: 'GET',
            url: path,

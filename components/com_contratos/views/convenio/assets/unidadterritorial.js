...
jQuery(document).ready(function() {
    ...
    jQuery('.editUndTrr').live("click", function() {
        ...
        if (data) {
            ...
            jQuery("#jform_intIDProvincia_dpa").trigger("change");
        }
    });
...
function clCmpUnidadTerritorial() {
    ...
    jQuery("#jform_intIDProvincia_dpa option").trigger('change', jQuery("#jform_intIDProvincia_dpa").val());
    recorrerCombo(jQuery("#jform_intIDCanton_dpa option"), 0);

    recorrerCombo(jQuery("#jform_intIDParroquia_dpa option"), 0);
}
/**
 * 

...
<div id="toolbar-box">
    <div class="m">
        ...
        <div class="pagetitle icon-48-contact">
            <h2> <?php echo ($this->item->intIdContrato_ctr == 0) ? JText::_( 'COM_CONTRATOS_GESTION_ADD_CONTRATO' ) : JText::_( 'COM_CONTRATOS_GESTION_EDIT_CONTRATO' ) ?> </h2>
        </div>
    </div>
</div>
...
<div id="element-box">
    <div class="m">
        ...
        <form action="<?php echo JRoute::_( 'index.php?option=com_contratos&layout=edit&intIdContrato_ctr=' . (int) $this->item->intIdContrato_ctr ); ?>" method="post" name="adminForm" id="contratos-form" class="form-validate" enctype="multipart/form-data" >
            ...
            <div id="contratosTab" class="width-100 fltlft">
                <ul>
                    ...
                    <li><a href="#otros">           <?php echo JText::_( 'COM_CONTRATOS_TAB_OTROS' ); ?></a></li>
                </ul>
                ...
                <!--Otros-->
                <div id="otros">      
                    <?php echo $this->loadTemplate( 'atributos' ); ?>
                </div>            
                <!--Otros-->
                <div id="objetivos">      
            ...
            <div>
                ...
                <?php echo $this->loadTemplate( 'pop_up' ); ?>
            </div>
        </form>

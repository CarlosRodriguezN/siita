 ...
 */
class contratosViewContratista extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'contratista.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'contratista.cancel', false);
    ...
    protected function setDocument() {
        ...
        JText::script('COM_CONTRATOA_CONTRATISTA_ERROR_UNACCEPTABLE');
    }

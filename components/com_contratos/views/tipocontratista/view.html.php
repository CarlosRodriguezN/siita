 ...
 */
class contratosViewTipoContratista extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'tipocontratista.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'tipocontratista.cancel', false);
    ...
    protected function setDocument() {
        ...
        JText::script('COM_CONTRATOA_TIPOCONTRATISTA_ERROR_UNACCEPTABLE');
    }

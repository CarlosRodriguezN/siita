 ...
 */
class contratosViewPartida extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'partida.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'partida.cancel', false);
    ...
    protected function setDocument() {
        ...
        JText::script('COM_CONTRATOA_PARTIDA_ERROR_UNACCEPTABLE');
    }

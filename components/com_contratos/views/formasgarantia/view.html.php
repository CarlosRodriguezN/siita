 ...
 */
class contratosViewFormasGarantia extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'formagarantia.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'formagarantia.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'formagarantia.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'formasgarantia.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'formasgarantia.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_ATRIBUTOS_ERROR_UNACCEPTABLE');
    }
}
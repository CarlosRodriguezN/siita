 ...
 */
class contratosViewTiposContratista extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'tipocontratista.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'tipocontratista.edit', true );
        $bar->appendButton( 'Separator' );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'tipocontratista.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'tiposcontratista.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'tiposcontratista.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CONTRATOS_TIPOSCONTRATISTAS_ERROR_UNACCEPTABLE');
    }
}
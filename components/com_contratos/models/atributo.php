 ...
 * Modelo tipo obra
 */
class contratosModelAtributo extends JModelAdmin {
    ...
    protected function loadFormData() {
        ...
        $data = JFactory::getApplication()->getUserState('com_contratos.edit.atributo.data', array());
    ...
    public function deleteAtributo($idAtributo) {
        ...
        return $tbAtribto->deleteAtributo($idAtributo);
    }

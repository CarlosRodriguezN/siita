 ...
 */
class contratosModelTiposContratista extends JModelList {
    ...
    public function __construct($config = array()) {
        if (empty($config['filter_fields'])) {
            ...
            $config['filter_fields'] = array('intIdTipoContratista_tpocta',
                'strDescripcion_tpocta '
            );
        }
    ...
    public function getItems() {
        ...
        foreach ($items as &$item) {
            $item->url = JRoute::_('index.php?option=com_contratos&amp;task=tipocontratista.edit&amp;idTipoContratista=' . $item->idTipoContratista);
        }
    ...
    public function getListQuery() {
        ...
        $query->select('    tpc.intIdTipoContratista_tpocta AS idTipoContratista,
                            tpc.strDescripcion_tpocta  AS descTipoContratista,
                            tpc.published');
        
        $query->from('#__ctr_tipo_contratista AS tpc');
        ...
        if (!empty($search)) {
            ...
            $field_searches = " tpc.intIdTipoContratista_tpocta LIKE '" . $search . "' OR"
                            . " tpc.strDescripcion_tpocta LIKE '" . $search . "'";

...
/**
 * Vista de Ingreso /Edicion de prioridad de un proyecto en la canasa de proyectos
 */
class CanastaproyViewCoordenadagraf extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'coordenadagraf.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'coordenadagraf.cancel', false);

...
/**
 * Vista de Ingreso /Edicion de grafico de un proyecto en la canasa de proyectos
 */
class CanastaproyViewGraficocp extends JView {
    ...
    protected function getToolbar() {
        ...
        $bar->appendButton('Standard', 'save', 'Guardar', 'graficocp.save', false);
        $bar->appendButton('Separator');
        $bar->appendButton('Standard', 'cancel', 'Cancelar', 'graficocp.cancel', false);
...
//        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/beneficiario/assets/reglas.js' );
        
        //  Adjunto libreria que controla ingreso de informacion especifica en los campos
//        $document->addScript( JURI::root(). 'components/com_mantenimiento/views/beneficiario/assets/vinculante.js' );

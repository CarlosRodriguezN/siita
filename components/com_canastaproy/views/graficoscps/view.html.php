 ...
 */
class CanastaproyViewGraficoscps extends JView
{
    /**
    * Metodo que muestra la lista de grafico de propuestas de proyectos
    * @return void
    */
    ...
    function display($tpl = null) 
    {
        ...
        //  la cual internamente accede al "CanastaproyModelGraficoscps" y ejecuta el metodo "getItems"
        ...
        //  "CanastaproyModelGraficoscps" del modelo
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'graficocp.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'graficocp.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'graficoscps.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'graficoscps.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_CANASTAPROY_GRAFICO_CP_ERROR_UNACCEPTABLE');
    }
}
...
<div id="content-box">
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-contact">
                <h2> <?php echo JText::_( 'COM_CANASTAPROY_ADMINISTRACION_COORDENADA_GRAF' ) ?> </h2>
            </div>
        </div>
    </div>
    ...
    <div id="element-box">
        <div class="m">
            <form action="<?php echo JRoute::_( 'index.php?option=com_canastaproy&amp;view=coordenadagraf' ); ?>" method="post" name="adminForm" id="adminForm">

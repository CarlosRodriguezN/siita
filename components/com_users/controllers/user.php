...
class UsersControllerUser extends UsersController
{
    ...
    public function login()
    {
        ...
        if( true === $app->login( $credentials, $options ) ){
            ...
            $app->redirect( JRoute::_( 'index.php?option=com_panel', false ) );

//            $user = JFactory::getUser();
//            $oPermisos = new Permisos();
//            $acces = $oPermisos->getAccesLogin($user);
//            
//                switch ($acces->acces){
//                case ("admin"):
//                case ("panel"):
...
//                    break;
//                case ("pei"):
//                    $app->redirect( JRoute::_( 'index.php?option=com_pei&view=pei&layout=edit&intId_pi=' . $acces->id, false ) );
//                    break;
//                case ("ug"):
//                    $app->redirect( JRoute::_( 'index.php?option=com_unidadgestion&view=unidadgestion&layout=edit&intCodigo_ug=' . $acces->id, false ) );
//                    break;
//                case ("fnc"):
//                    $app->redirect( JRoute::_( 'index.php?option=com_funcionarios&view=funcionario&layout=edit&intCodigo_fnc=' . $acces->id, false ) );
//                    break;
//                case ("sincargo"):
//                    $this->logout();
//                    break;

    ...
    <form action="?" method="post" name="adminForm" id="cobertura-form" class="form-validate">
        ...
        <div class="width-50 fltlft">
            <fieldset class="adminform">
                <legend> <?php echo JText::_('COM_PROYECTOS_FIELD_PLANIFICACION_INDICADOR_TITLE') ?> </legend>
                <table id="lstPlanificacionIndicadores" width="100%" class="tablesorter" cellspacing="1">
                    <thead>
                        <tr>
                            <th align="center"> <?php echo JText::_('COM_PROYECTOS_FIELD_PLANIFICACION_FECHA_LABEL') ?> </th>
                            <th align="center"> <?php echo JText::_('COM_PROYECTOS_FIELD_PLANIFICACION_VALOR_LABEL') ?> </th>
        ...
        <div class="width-50 fltrt">
            <fieldset class="adminform">
                ...
                <div class="clr"></div>
                <div class="fltlft">
                    <input id="btnAddPlanIndicador" type="button" value="<?php echo JText::_('COM_PROYECTOS_ADD_PLANIFICACION_TITLE') ?>">
                </div>
                <div class="clr"></div>
            </fieldset>
        </div>

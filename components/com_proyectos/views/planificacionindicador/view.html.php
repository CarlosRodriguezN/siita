 ...
 * Vista Fase
 */
class ProyectosViewPlanificacionIndicador extends JView
{
    /**
    ...
    */
    public function display($tpl = null) 
    {
        ...
        $this->title = JText::_( 'COM_PROYECTO_PLANIFICACION_INDICADOR' );
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'save', 'Guardar', 'planificacionindicador.asignar', false );
        $bar->appendButton( 'Standard', 'cancel', 'Cancelar', 'planificacionindicador.cancel', false );
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root(). 'components/com_proyectos/views/planificacionindicador/assets/Reglas.js' );
        
        //  Adjunto libreria que la clase de Unidad Territorial
        $document->addScript( JURI::root(). 'components/com_proyectos/views/planificacionindicador/assets/Planificacion.js' );
        
        //  Adjunto libreria que la gestion de Unidad Territorial
        $document->addScript( JURI::root(). 'components/com_proyectos/views/planificacionindicador/assets/GestionPlanificacion.js' );

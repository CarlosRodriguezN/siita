...
<div id="content-box">
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-contact">
                <h2> <?php echo JText::_( 'COM_PROYECTOS_ADMINISTRATION_PROYECTO' ) ?> </h2>
            </div>
        </div>
    </div>
    ...
    <?php $admMapas = JFactory::getUser()->authorise( 'core.admin', 'com_adminmapas' );?>
    <?php $admMantenimiento = JFactory::getUser()->authorise( 'core.admin', 'com_mantenimiento' );?>

    <?php if( $admMapas || $admMantenimiento ): ?>
        <div id="submenu-box">
            <div class="m">
                <ul id="submenu">
                    <?php if( $admMapas ): ?>
                        <li>
                            <a class="active" href="index.php?option=com_adminmapas" title="<?php echo JText::_( 'COM_PROYECTO_MAPAS_TITLE' ); ?>"> <?php echo JText::_( 'COM_PROYECTO_MAPAS' ) ?> </a>
                        </li>
                    <?php endif; ?>
                        
                    <?php if( $admMantenimiento ): ?>                        
                        <li>
    ...
    <div id="element-box">
        <div class="m">
            <form action="<?php echo JRoute::_( 'index.php?option=com_proyectos&amp;view=proyectos' ); ?>" method="post" name="adminForm" id="adminForm">
...
<!--                    <input type="hidden" name="view" value="Proyectos" />-->

    ...
    <form action="?" method="post" name="adminForm" id="cobertura-form" class="form-validate">
        ...
        <div class="width-50 fltlft">
            <fieldset class="adminform">
                <legend> <?php echo JText::_('COM_PROYECTOS_FIELD_PROYECTO_ENFOQUE_TITLE') ?> </legend>
                <table id="lstEnfoques" width="100%" class="tablesorter" cellspacing="1">
                    <thead>
                        <tr>
                            <th align="center"> <?php echo JText::_('COM_PROYECTOS_INDICADOR_DIMENSION_LABEL') ?> </th>
                            <th align="center"> <?php echo JText::_('COM_PROYECTOS_INDICADOR_ENFOQUE_LABEL') ?> </th>
        ...
        <div class="width-50 fltrt">
            <fieldset class="adminform">
                <legend> <?php echo JText::_('COM_PROYECTOS_FIELD_PROYECTO_DIMENSION_TITLE') ?> </legend>
                ...
                <div class="fltlft">
                    <input id="btnAddEnfoque" type="button" value="<?php echo JText::_('COM_PROYECTOS_INDICADOR_ADDDIMENSION_TITLE') ?>">
                </div>
                <div class="clr"></div>
            </fieldset>
        </div>

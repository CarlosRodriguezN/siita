 ...
 * Vista Fase
 */
class ProyectosViewEnfoque extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'save', 'Guardar', 'enfoque.asignar', false );
        $bar->appendButton( 'Standard', 'cancel', 'Cancelar', 'enfoque.cancel', false );
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root(). 'components/com_proyectos/views/enfoque/assets/Vinculantes.js' );
        
        //  Adjunto libreria que la clase de Unidad Territorial
        $document->addScript( JURI::root(). 'components/com_proyectos/views/enfoque/assets/GestionEnfoque.js' );
        
        //  Adjunto libreria que la gestion de Unidad Territorial
        $document->addScript( JURI::root(). 'components/com_proyectos/views/enfoque/assets/Enfoque.js' );
        
        //  Adjunto libreria que la gestion de Unidad Territorial        
        $document->addScript( JURI::root(). 'components/com_proyectos/views/enfoque/assets/Reglas.js' );

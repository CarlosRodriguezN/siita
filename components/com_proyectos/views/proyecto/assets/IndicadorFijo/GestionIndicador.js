...
GestionIndicador.prototype.addFilaOtroIndicador = function( objOtroInd, ban )
{
    ...
    fila += "       <td align='center'> <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"'> </td>"
            + "     <td align='left'>" + objOtroInd.nombreIndicador + "</td>"
            + "     <td align='left'>" + objOtroInd.descripcion + "</td>"
            + "     <td align='center'>" + objOtroInd.umbral + ' / ' + objOtroInd.undMedida + "</td>"
            + "     <td align='left'>" + objOtroInd.formula + "</td>";
    ...
    fila += "       <td align='center' style='vertical-align: middle;width: 70px;'> <a class='delOI'> Eliminar </a> </td>";
...
GestionIndicador.prototype.getDtaSemaforizacion = function( banIndicador ){
    ...
    switch( banIndicador ){
        //  Rojo
        case 0: 
            dtaSemaforizacion["imgAtributo"] = COM_PROYECTOS_RG_ATRIBUTO;
            dtaSemaforizacion["msgAtributo"] = COM_PROYECTOS_TITLE_RG_ATRIBUTO;
        break;

        //  Amarillo
        case 1: 
            dtaSemaforizacion["imgAtributo"]= COM_PROYECTOS_AM_ATRIBUTO;
            dtaSemaforizacion["msgAtributo"]= COM_PROYECTOS_TITLE_AM_ATRIBUTO;
            dtaSemaforizacion["msgStyle"]   = COM_PROYECTOS_STYLE_AM ;
        break;

        //  Verde
        case 2: 
            dtaSemaforizacion["imgAtributo"] = COM_PROYECTOS_VD_ATRIBUTO;
            dtaSemaforizacion["msgAtributo"] = COM_PROYECTOS_TITLE_VD_ATRIBUTO;
        break;
    }

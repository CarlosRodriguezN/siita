...
function initialize() {
    ...
    //var LatLngc = new google.maps.LatLng(-34.397, 150.644);
    var myOptions = {
        center: LatLngc,
        zoom: 8,
        mapTypeId: google.maps.MapTypeId.ROADMAP
    };
    mapProyecto = new google.maps.Map( document.getElementById( "mapa_proyectosdiv" ), myOptions );
} 

jQuery( document ).ready( function(){
    jQuery( '#vwCoodenada' ).click(function(){
        initialize();
    })
});

 ...
 * Vista Fase
 */
class ProyectosViewUnidadTerritorial extends JView
{
    /**
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root(). 'components/com_proyectos/views/unidadterritorial/assets/Vinculantes.js' );
        
        //  Adjunto libreria que la clase de Unidad Territorial
        $document->addScript( JURI::root(). 'components/com_proyectos/views/unidadterritorial/assets/GestionUndTerritorial.js' );
        
        //  Adjunto libreria que la gestion de Unidad Territorial
        $document->addScript( JURI::root(). 'components/com_proyectos/views/unidadterritorial/assets/UnidadTerritorial.js' );
        
        //  Adjunto libreria que la gestion de Unidad Territorial        
        $document->addScript( JURI::root(). 'components/com_proyectos/views/unidadterritorial/assets/Reglas.js' );

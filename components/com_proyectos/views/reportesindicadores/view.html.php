 ...
 */
class ProyectosViewReportesIndicadores extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'cancel', JText::_( 'COM_PROYECTOS_REPORTE_INDICADORES_CANCEL' ), 'reporteindicador.cancel', false );

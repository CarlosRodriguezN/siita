 ...
 * Modelo Fase
 */
class ProyectosModelPlanificacionVariable extends JModelAdmin
{
    /**
    ...
    */
    ...
    {
        // Get the form.
        $form = $this->loadForm( 'com_proyectos.planificacionvariable', 'planificacionvariable', array( 'control' => 'jform', 'load_data' => $loadData ) );
    ...
    */
    protected function loadFormData() 
    {
        ...
        $data = JFactory::getApplication()->getUserState( 'com_proyectos.edit.planificacionvariable.data', array() );

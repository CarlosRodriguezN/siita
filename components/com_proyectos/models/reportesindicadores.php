 ...
 * Etapas Model
 */
class ProyectosModelReportesIndicadores extends JModelList
{
    /**
    * Items total
    * @var integer
    ...
    */
    ...
    public function getItems()
    {
        ...
        foreach( $items as &$item ){
            $item->url = JRoute::_('index.php?option=com_proyectos&amp;view=reporteindicador&amp;task=reporteindicador.pdf&amp;idIndEntidad='. $item->idIndEntidad );
        }

 ...
 * Etapas Model
 */
class ProyectosModelCoberturas extends JModelList
{
    ...
    public function getItems()
    {
        ...
        foreach( $items as &$item ){
            $item->url = JRoute::_('index.php?option=com_proyectos&amp;task=cobertura.edit&amp;inpcodigo_cb='. $item->inpcodigo_cb );
        }
    ...
    public function getListQuery()
    {
        ...
        $query->select( '   c.inpcodigo_cb,
                            c.strdescripcion_cb,
                            c.published,
                            u.name' );
        $query->from( '#__pfr_cobertura c' );
        ...
        if( !empty ( $search ) ){
            ...
            $field_searches = " c.strdescripcion_cb LIKE '". $search ."'";

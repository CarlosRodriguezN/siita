 ...
 * Etapas Model
 */
class ProgramaModelTiposPlanificacion extends JModelList
{
    ...
    public function getItems()
    {
        ...
        foreach( $items as &$item ){
            $item->url = JRoute::_('index.php?option=com_programas&amp;task=lineabase.edit&amp;intCodigo_lbind='. $item->intCodigo_lbind );
        }
    ...
    public function getListQuery()
    {
        ...
        $query->select( '   t1.intcodigo_per AS idTipoPlanificacion,
                            t1.strdescripcion_per AS tipoPlanificacion,
                            t1.published,
                            u.name' );
        ...
        if( !empty ( $search ) ){
            ...
            $field_searches = " t1.strdescripcion_per LIKE '". $search ."'";
    ...
    public function getLstInstituciones()
    {
        try {
            ...
            $log = &JLog::getInstance('com_programas.tables.log.php');

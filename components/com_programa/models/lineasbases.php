 ...
 * Etapas Model
 */
class ProgramaModelLineasBases extends JModelList
{
    ...
    public function getItems()
    {
        ...
        foreach( $items as &$item ){
            $item->url = JRoute::_('index.php?option=com_programa&amp;task=lineabase.edit&amp;intCodigo_lbind='. $item->intCodigo_lbind );
        }
    ...
    public function getLstInstituciones( $idIndicador = 0 )
    {
        try {
            ...
            $log = &JLog::getInstance('com_programa.tables.log.php');

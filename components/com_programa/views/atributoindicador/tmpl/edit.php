...
<div id="element-box">
    <div id="tabsAttrIndicador" style="position: static; left: 20px; height: auto; width: 100%">
        <ul>
            <li><a href="#generales"> <?php echo JText::_( 'COM_PROGRAMA_FIELD_ATRIBUTO_GENERAL' ) ?></a></li>
            <li><a href="#lineaBase"> <?php echo JText::_( 'COM_PROGRAMA_FIELD_ATRIBUTO_LINEABASE' ) ?></a></li>
            <li><a href="#unidadTerritorial"> <?php echo JText::_( 'COM_PROGRAMA_FIELD_ATRIBUTO_UNDTERRITORIAL' ) ?></a></li>
            <li><a href="#rango"> <?php echo JText::_( 'COM_PROGRAMA_FIELD_ATRIBUTO_RANGO' ) ?></a></li>            
            <li><a href="#variables"> <?php echo JText::_( 'COM_PROGRAMA_FIELD_ATRIBUTO_VARIABLE' ) ?></a></li>
            
            <!-- DISPONIBLE SOLO PARA OTROS INDICADORES - Pestaña de Gestion de Dimensiones -->
            <?php if( $this->_tpoIndicador == 'oi' ): ?>

            <li><a href="#dimensiones"> <?php echo JText::_( 'COM_PROGRAMA_FIELD_ATRIBUTO_DIMENSION' ) ?></a></li>

    ...
    <div class="width-50 fltlft">
        <fieldset class="adminform">
            ...
            <table id="lstUndTerritorialesInd" width="100%" class="tablesorter" cellspacing="1">
                <thead>
                    <tr>
                        <th align="center"> <?php echo JText::_( 'COM_PROGRAMA_FIELD_PROYECTO_PROVINCIA_LABEL' ) ?> </th>
                        <th align="center"> <?php echo JText::_( 'COM_PROGRAMA_FIELD_PROYECTO_CANTON_LABEL' ) ?> </th>
                        <th align="center"> <?php echo JText::_( 'COM_PROGRAMA_FIELD_PROYECTO_PARROQUIA_LABEL' ) ?> </th>                                

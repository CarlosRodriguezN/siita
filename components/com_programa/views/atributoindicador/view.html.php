 ...
 * Vista Fase
 */
class ProgramaViewAtributoIndicador extends JView
{
    /**
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/Reglas.js' );
        
        //  Adjunto libreria que la gestion de Combos Vinculantes
        $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/Vinculantes.js' );
        
        //  Adjunto libreria que la gestion de Atributos de un Indicador
        $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/GestionAtributos.js' );
        
        //  Adjunto libreria que la gestion de Unidad Territorial
        $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/GestionUndTerritorial.js' );
        
        //  Adjunto libreria Unidad Territorial
        $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/UnidadTerritorial.js' );
        
        //  Adjunto libreria que la gestion de Linea Base
        $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/GestionLineaBase.js' );
        
        //  Adjunto libreria clase Linea Base
        $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/LineaBase.js' );
        
        //  Adjunto libreria que la gestion de Rangos
        $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/GestionRangos.js' );
        
        //  Adjunto libreria clase Rango
        $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/Rango.js' );
        
        //  Adjunto libreria clase Variable 
        $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/Variable.js' );        
        
        //  Adjunto libreria que la gestion de Variables
        $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/GestionVariables.js' );
        ...
        if( $this->_tpoIndicador == oi ){
            ...
            $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/Dimension.js' );
            
            //  Adjunto libreria Clase Gestion Enfoque
            $document->addScript( JURI::root(). '/components/com_programa/views/atributoindicador/assets/GestionDimension.js' );
        }

 ...
 */
class ProgramaViewLineasBases extends JView
{
    /**
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root(). 'components/com_programa/views/lineasbases/assets/lineabase.js' );
        
        //  Adjunto libreria de gestion de Reglas
        $document->addScript( JURI::root(). 'components/com_programa/views/lineasbases/assets/Reglas.js' );

...
<div id="content-box">
    ...
    <div id="element-box">
        <div class="m">
            <form action="<?php echo JRoute::_( 'index.php?option=com_programa&amp;view=lineasbases' ); ?>" method="post" name="adminForm" id="adminForm">
                <fieldset id="filter-bar">
                    ...
                    <div class="filter-select fltrt">
                        <select id="idFuente" name="idFuente" class="inputbox" onchange="this.form.submit()">
                            <option value="0"> <?php echo JText::_( 'COM_PROGRAMA_LINEABASE' ); ?> </option>

...
GestionIndicador.prototype.addFilaIndicadorGAP = function( dtaIndGap, ban )
{
        ...
        fila += "       <td align='center'>"
             + "            <a id='aif-gap-" + dtaIndGap.idRegGap + "'onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndGap.gapFemenino.idIndicador +"&tpo=f&tpoIndicador=gap&idRegIndicador="+ dtaIndGap.idRegGap +"&tmpl=component&task=preview\", {size:{x:"+ COM_PROGRAMA_POPUP_ANCHO +", y: "+ COM_PROGRAMA_POPUP_ALTO +"}, handler:\"iframe\"} );'>"        
        fila += "               <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"' >";
             + "            </a>"
             + "     </td>"; 
...
GestionIndicador.prototype.addFilaIndEIgualdad = function( tpoEnfoque, EIgualdad, dtaIndEIgualdad, ban )
{
    ...
    fila += "       <td align='center'>"
         + "         <a id='aim-ei-" + dtaIndEIgualdad.idRegEI + "' onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndEIgualdad.eiMasculino.idIndicador +"&tpo=m&tpoIndicador=ei&idRegIndicador="+ dtaIndEIgualdad.idRegEI +"&tmpl=component&task=preview\", {size:{x:"+ COM_PROGRAMA_POPUP_ANCHO +", y: "+ COM_PROGRAMA_POPUP_ALTO +"}, handler:\"iframe\"} );'>";
    fila += "               <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"'>"
         + "         </a>"
         + "     </td>";
    ...
    fila += "       <td align='center'>"
         + "         <a id='aif-ei-" + dtaIndEIgualdad.idRegEI + "'onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndEIgualdad.eiFemenino.idIndicador +"&tpo=f&tpoIndicador=ei&idRegIndicador="+ dtaIndEIgualdad.idRegEI +"&tmpl=component&task=preview\", {size:{x:"+ COM_PROGRAMA_POPUP_ANCHO +", y: "+ COM_PROGRAMA_POPUP_ALTO +"}, handler:\"iframe\"} );'>";
    fila += "               <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"' >"
         + "         </a>"
         + "     </td>";
...
GestionIndicador.prototype.addFilaIndEEcorae = function( EEcorae, dtaIndEEcorae, ban )
{
    ...
    fila += "       <td align='center'>"
         + "         <a id='aif-ee-" + dtaIndEEcorae.idRegEE + "'onclick='SqueezeBox.fromElement( \"index.php?option=com_indicadores&view=indicador&layout=edit&idIndicador="+ dtaIndEEcorae.eeFemenino.idIndicador +"&tpo=f&tpoIndicador=ee&idRegIndicador="+ dtaIndEEcorae.idRegEE +"&tmpl=component&task=preview\", {size:{x:"+ COM_PROGRAMA_POPUP_ANCHO +", y: "+ COM_PROGRAMA_POPUP_ALTO +"}, handler:\"iframe\"} );'>";
    fila += "               <img src='"+ ds["imgAtributo"] +"' title='"+ ds["msgAtributo"] +"' style='"+ ds["msgStyle"] +"' >"
         + "         </a>"
         + "     </td>";
...
GestionIndicador.prototype.addFilaOtroIndicador = function( objOtroInd, ban )
{
    ...
    fila += "       <td align='center'> <img class='sprite-indicadores' id='ai-oi-" + objOtroInd.idRegIndicador + "' title='" + COM_PROGRAMA_TITLE_ATRIBUTO + "' > </td>"

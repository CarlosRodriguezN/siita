...
//
    ...
    jQuery('#btnAddGAP').live('click', function() {
        ...
        if( banIdGAP == -1 ){
            if( !objGestionIndicador.existeIndGap( idTpoGap ) ) {
                ...
                objIndMasculino.idDimension = idTpoGap;
                ...
                objIndFemenino.idDimension = idTpoGap;
                ...
                objIndTotal.idDimension = idTpoGap;
    ...
    jQuery( '.delGAP' ).live( 'click', function(){
        ...
        jConfirm( "Está seguro que desea eliminar este registro?", "SIITA - ECORAE", function( result ){
            if( result ) {

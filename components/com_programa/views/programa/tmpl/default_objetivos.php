...
<div class="width-60 fltlft">
    <fieldset class="adminform">
        ...
        <table id="tbLstObjetivos" width="100%" class="tablesorter" cellspacing="1">
            <thead>
                <tr>
                    <th align="center"><?php echo JText::_( 'COM_PROGRAMAS_FIELD_OBJETIVO_DESCRIPCION_LABEL' ) ?></th>
                    <th colspan="1" align="center"><?php echo JText::_( 'COM_PROGRAMAS_FIELD_OBJETIVO_ALINEACION_LABEL' ) ?></th>
                    <th colspan="2" align="center"><?php echo JText::_( 'COM_PROGRAMAS_FIELD_OBJETIVO_PLAN_ACCION_LABEL' ) ?></th>
...
<div class="width-40 fltrt" >
    ...
    <div id="frmObjetivo" class ="hide" >
        <fieldset class="adminform">
            <legend> <?php echo JText::_( 'COM_PROGRAMAS_FIELD_DATA_GENERAL_LABEL' ) ?> </legend>

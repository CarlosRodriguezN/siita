 ...
 * Vista Fase
 */
class ProgramaViewEnfoque extends JView
{
    /**
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root(). 'components/com_proyecto/views/enfoque/assets/Vinculantes.js' );
        
        //  Adjunto libreria que la clase de Unidad Territorial
        $document->addScript( JURI::root(). 'components/com_proyecto/views/enfoque/assets/GestionEnfoque.js' );
        
        //  Adjunto libreria que la gestion de Unidad Territorial
        $document->addScript( JURI::root(). 'components/com_proyecto/views/enfoque/assets/Enfoque.js' );
        
        //  Adjunto libreria que la gestion de Unidad Territorial        
        $document->addScript( JURI::root(). 'components/com_proyecto/views/enfoque/assets/Reglas.js' );

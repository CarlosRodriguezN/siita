 ...
 */
class ProgramaViewTiposSubPrograma extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'tiposubprograma.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'tiposubprograma.edit', true );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'tiposubprograma.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'tipossubprogramas.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'tipossubprogramas.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_PROGRAMA_TIPO_SUB_PROGRAMAS_ERROR_UNACCEPTABLE');
    }
}
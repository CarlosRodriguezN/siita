 ...
 */
class ProgramaViewTiposPlanificacion extends JView
{
    /**
    * 
    ...
    */
    ...
    function display($tpl = null) 
    {
        ...
        $this->title = JText::_('COM_PROGRAMAS_ADD_LINEABASE_TITLE');
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Asignar', 'tiposplanificacion.asignar', false );
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root(). 'components/com_programa/views/tiposplanificacion/assets/tiposplanificacion.js' );

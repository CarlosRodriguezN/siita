 ...
 */
class ProgramaViewSubProgramas extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'subprograma.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'subprograma.edit', true );
        $bar->appendButton( 'Standard', 'delete', 'Eliminar', 'subprograma.delete', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'publish', 'Publicar', 'subprogramas.publish', true );
        $bar->appendButton( 'Standard', 'unpublish', 'Despublicar', 'subprogramas.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        JText::script('COM_PROGRAMA_SUB_PROGRAMAS_ERROR_UNACCEPTABLE');
    }
}
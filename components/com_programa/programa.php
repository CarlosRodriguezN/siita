...
if ( JFactory::getUser()->guest ) {
    ...
    $app->redirect();
} else if ( !JFactory::getUser()->authorise( 'core.admin', 'com_programa' ) ){
...
//  Require helper file
JLoader::register( 'ProgramaHelper', JPATH_ADMINISTRATOR . DS . 'components'. DS . 'com_programa'. DS .'helpers' . DS . 'programa.php' );

 ...
 * Vista Fase
 */
class PoaViewAtributoIndicador extends JView
{
    /**
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/GestionObjetivoIndicador.js' );
        
        //  Adjunto libreria que la gestion Presentacion de informacion de un Indicadores asociados a un indicador
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/ReglasInicio.js' );
        
        //  Adjunto clase indicador
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/Indicador.js' );

        //  Adjunto libreria que la gestion de Reglas de validacion de un formulario
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/Reglas.js' );
        
        //  Adjunto libreria que la gestion de Combos Vinculantes
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/Vinculantes.js' );
        
        //  Adjunto libreria que la gestion de Unidad Territorial
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/GestionUndTerritorial.js' );
        
        //  Adjunto libreria Unidad Territorial
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/UnidadTerritorial.js' );
        
        //  Adjunto libreria que la gestion de Linea Base
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/GestionLineaBase.js' );
        
        //  Adjunto libreria clase Linea Base
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/LineaBase.js' );
        
        //  Adjunto libreria que la gestion de Rangos
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/GestionRangos.js' );
        
        //  Adjunto libreria clase Rango
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/Rango.js' );
        
        //  Adjunto libreria clase Variable 
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/Variable.js' );        
        
        //  Adjunto libreria que la gestion de Variables
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/GestionVariables.js' );
        
        //  Adjunto libreria Clase Enfoque
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/Dimension.js' );

        //  Adjunto libreria Clase Gestion Enfoque
        $document->addScript( JURI::root(). 'components/com_pei/views/atributoindicador/assets/GestionDimension.js' );

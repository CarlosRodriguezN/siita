...
/**
 * Vista de Ingreso/Edicion de un plan accion de un POA
 */
class PoaViewPlnAccion extends JView
{
    ...
    public function display( $tpl = null )
    {
        ...
        $this->item = $item;
        $this->script = $script;
        $this->idObjetivo = JRequest::getVar("registroObj");
    ...
    protected function setDocument()
    {
        ...
        $document->addScript( JURI::root() . 'components/com_poa/views/plnaccion/assets/ES_ACCION.js' );
        ...
        $document->addScript( JURI::root() . 'components/com_poa/views/plnaccion/assets/ReglasPA.js' );

        //  Adjunto libreria que controla ingreso de informacion especifica en los campos
        $document->addScript( JURI::root() . 'components/com_poa/views/plnaccion/assets/Accion.js' );

        //  Adjunto libreria que controla ingreso de informacion especifica en los campos
        $document->addScript( JURI::root() . 'components/com_poa/views/plnaccion/assets/GestionAcciones.js' );
        
        //  Adjunto libreria para cargar la el pan de accion de un objetivo
        //  $document->addScript( JURI::root() . 'components/com_poa/views/plnaccion/assets/LoadPlanAccion.js' );

        //  Adjunto libreria para actualizacion de los combos vinculantes
        $document->addScript( JURI::root() . 'components/com_poa/views/plnaccion/assets/Vinculantes.js' );
        
        //  Adjunto libreria para la gestion de acciones de un objetivo
        //  $document->addScript( JURI::root() . 'components/com_poa/views/plnaccion/assets/PlnAccion.js' );
        
        //  Adjunto libreria para el contro de los botonee de guarad y cancelar del livebox
        $document->addScript( JURI::root() . 'components/com_poa/views/plnaccion/assets/Save.js' );

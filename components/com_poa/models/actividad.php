 ...
 */
class PoaModelActividad extends JModelAdmin {
     ...
     * @since	1.6
     */
    public function getTable($type = 'Actividad', $prefix = 'PoaTable', $config = array()) {
    ...
    public function getForm($data = array(), $loadData = true) {
        // Get the form.
        $form = $this->loadForm('com_poa.actividad', 'actividad', array('control' => 'jform', 'load_data' => $loadData));
    ...
    protected function loadFormData() {
        ...
        $data = JFactory::getApplication()->getUserState('com_poa.edit.actividad.data', array());

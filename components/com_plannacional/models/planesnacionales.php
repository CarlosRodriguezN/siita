...
class plannacionalModelPlanesnacionales extends JModelList
{
    public function __construct( $config = array() ) 
    {
        if( empty( $config['filter_fields'] ) ){
            ...
            $config['filter_fields'] = array(   'intCodigo_pn', 
                                                'strDescripcion_pn',
                                                'dteFechaInicio_pn',
                                                'dteFechafFin_pn',
                                                'blnVigente_pn'
    ...
    public function getListQuery()
    {
        ...
        $query->select( '   pln.intCodigo_pn,
                            pln.strDescripcion_pn,
                            pln.dteFechaInicio_pn,
                            pln.dteFechafFin_pn,
                            pln.blnVigente_pn,
                            pln.published,
                            u.name' );
        ...
        if( !empty ( $search ) ){
            ...
            $field_searches = " pln.strDescripcion_pn LIKE '". $search ."' OR"
                            . " pln.dteFechaInicio_pn LIKE '". $search ."' OR"
                            . " pln.dteFechafFin_pn LIKE '". $search ."' OR"
                            . " pln.blnVigente_pn LIKE '". $search ."'";

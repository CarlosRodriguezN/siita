...
<div id="element-box">
   <div class="m">
      <form action="<?php echo JRoute::_('index.php?option=com_plannacional&layout=edit&intCodigo_pln=' . (int) $this->item->intCodigo_pln); ?>" method="post" name="adminForm" id="fase-form" class="form-validate">

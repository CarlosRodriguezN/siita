...
class plannacionalViewIndicadoresnacionales extends JView
{
    ...
    */
    protected function getToolbar() 
    {
        ...
        $bar->appendButton( 'Standard', 'new', 'Nuevo', 'indicadornacional.add', false );
        $bar->appendButton( 'Standard', 'edit', 'Editar', 'indicadornacional.edit', true );
        
        $bar->appendButton( 'Separator' );
        
        $bar->appendButton( 'Standard', 'new', 'Publicar', 'indicadoresnacionales.publish', true );
        $bar->appendButton( 'Standard', 'edit', 'Despublicar', 'indicadoresnacionales.unpublish', true );
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->setTitle( JText::_( 'COM_PLANNACIONAL_ADMINISTRATION_INDICADORESNACIONALES' ) );
    }
}
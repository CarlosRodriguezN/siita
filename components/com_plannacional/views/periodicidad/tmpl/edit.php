...
<div id="element-box">
   <div class="m">
      <form action="<?php echo JRoute::_('index.php?option=com_plannacional&layout=edit&intCodigo_per=' . (int) $this->item->intCodigo_per); ?>" method="post" name="adminForm" id="fase-form" class="form-validate">

 ...
 */
class UnidadGestionViewPoa extends JView {
    ...
    public function display($tpl = null) {
        ...
        $this->idEntidadUG = (int)  JRequest::getVar('idEntidadUG');
    ...
    protected function setDocument() {
        ...
        $document->addScript( JURI::root() . 'components/com_unidadgestion/views/poa/assets/ES-POA.js' );

        //  Adjunto libreria que controla ingreso de informacion especifica en los campos
        $document->addScript( JURI::root() . 'components/com_unidadgestion/views/poa/assets/Reglas.js' );
        
        //  Adjunto libreria para el control de los botonee de guarad y cancelar del livebox
        $document->addScript( JURI::root() . 'components/com_unidadgestion/views/poa/assets/Save.js' );

...
<div id="content-box">
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-contact">
                <h2> <?php echo JText::_('COM_UNIDAD_GESTION_ADMINISTRACION_UNIDAD_GESTION') ?> </h2>
            </div>
        </div>
    </div>
    ...
    <div class="m">
        <ul id="submenu">
            <li>
                <a class="active" href="index.php?option=com_unidadgestion&amp;task=unidadgestion.edit&amp;intCodigo_ug=4"> <?php echo JText::_('COM_CONTRATOS_GESTION_RECURSOS_ORGANIZACIONALES'); ?></a>
            </li>
    ...
    <div id="element-box">
        <div class="m">
            <form action="<?php echo JRoute::_('index.php?option=com_unidadgestion&amp;view=unidadesgestion'); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">

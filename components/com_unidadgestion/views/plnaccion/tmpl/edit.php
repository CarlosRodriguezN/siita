    ...
    <div class="m">
        ...
        <div class="pagetitle icon-48-contact">
            ...
            <h2> <?php if( $this->item->intId_plnAccion == null ): ?>
                    <?php echo JText::_( 'COM_UNIDAD_GESTION_PLAN_ACCION_CREATING' ); ?>
                <?php else: ?>
                    <?php echo JText::_( 'COM_UNIDAD_GESTION_PLAN_ACCION_EDITING' ); ?>
                <?php endif; ?>
            </h2>
        </div>
    </div>
...
<div id="element-box">
    <form action="<?php echo JRoute::_( 'index.php?option=com_unidadgestion&layout=edit&intId_plnAccion=' . (int) $this->item->intId_plnAccion ); ?>" method="post" name="adminForm" >
        <div class="width-100">

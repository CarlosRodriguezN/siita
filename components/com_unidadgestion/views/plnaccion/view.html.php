 ...
 */
class UnidadGestionViewPlnAccion extends JView
{
    ...
    public function display( $tpl = null )
    {
        ...
        $this->item = $item;
        $this->script = $script;
        $this->idRegObjetivo = (int)JRequest::getVar("registroObj");
        $this->idRegPoa = (int)JRequest::getVar("registroPoa");
        $this->idUG = (int)JRequest::getVar("idUG");
    ...
    protected function setDocument()
    {
        ...
        $document->addScript( JURI::root() . 'components/com_unidadgestion/views/plnaccion/assets/ES_ACCION.js' );

        //  Adjunto libreria que controla ingreso de informacion especifica en los campos
        $document->addScript( JURI::root() . 'components/com_unidadgestion/views/plnaccion/assets/ReglasPA.js' );

        //  Adjunto libreria que controla ingreso de informacion especifica en los campos
        $document->addScript( JURI::root() . 'components/com_unidadgestion/views/plnaccion/assets/Accion.js' );

        //  Adjunto libreria para actualizacion de los combos vinculantes
        $document->addScript( JURI::root() . 'components/com_unidadgestion/views/plnaccion/assets/Vinculantes.js' );

        //  Adjunto libreria que controla ingreso de informacion especifica en los campos
        $document->addScript( JURI::root() . 'components/com_unidadgestion/views/plnaccion/assets/GestionAcciones.js' );
        
        //  Adjunto libreria para el contro de los botonee de guarad y cancelar del livebox
        $document->addScript( JURI::root() . 'components/com_unidadgestion/views/plnaccion/assets/Save.js' );

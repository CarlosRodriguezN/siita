 ...
 */
class UnidadGestionModelPlnAccion extends JModelAdmin
{
     ...
     * @since	1.6
     */
    public function getTable( $type = 'PlnAccion', $prefix = 'UnidadGestionTable', $config = array( ) )
    {
    ...
    public function getForm( $data = array( ), $loadData = true )
    {
        ...
        // Get the form.
        $form = $this->loadForm( 'com_unidadgestion.plnaccion', 'plnaccion', array( 'control' => 'jform', 'load_data' => $loadData ) );
        $this->testForm = $form;
    ...
    protected function loadFormData()
    {
        ...
        $data = JFactory::getApplication()->getUserState( 'com_unidadgestion.plnaccion.plnaccion.data', array( ) );

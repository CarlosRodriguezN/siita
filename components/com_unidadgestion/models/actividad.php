 ...
 */
class UnidadGestionModelActividad extends JModelAdmin {
     ...
     * @since	1.6
     */
    public function getTable($type = 'Actividad', $prefix = 'UnidadGestionTable', $config = array()) {
    ...
    public function getForm($data = array(), $loadData = true) {
        // Get the form.
        $form = $this->loadForm('com_unidadgestion.actividad', 'actividad', array('control' => 'jform', 'load_data' => $loadData));
    ...
    protected function loadFormData() {
        ...
        $data = JFactory::getApplication()->getUserState('com_unidadgestion.edit.actividad.data', array());

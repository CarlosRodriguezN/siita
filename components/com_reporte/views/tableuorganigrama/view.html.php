...
class ReporteViewTableuOrganigrama extends JView
{
    ...
    protected function setDocument()
    {
        ...
        $document->addScript( JURI::root() . 'components/com_reporte/views/tableuorganigrama/assets/general.js' );
        $document->addScript( JURI::root() . 'components/com_reporte/views/tableuorganigrama/assets/editable.js' );
        $document->addScript( JURI::root() . 'components/com_reporte/views/tableuorganigrama/assets/gestionEditable.js' );

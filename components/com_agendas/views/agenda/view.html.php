 ...
 */
class AgendasViewAgenda extends JView
{
    ...
    public function display( $tpl = null )
    {
        ...
        $this->canDo = AgendaHelper::getActions();
    ...
    protected function getToolbar()
    {
        ...
        if( $this->canDo->get( 'core.create' ) || $this->canDo->get( 'core.edit' ) ){
            $bar->appendButton( 'Standard', 'save', JText::_( 'COM_AGENDAS_GUARDAR' ), 'agenda.save', false );
            $bar->appendButton( 'Standard', 'save', JText::_( 'COM_AGENDAS_GUARDAR_SALIR' ), 'agenda.saveExit', false );
        }

//        if( $this->canDo->get( 'core.delete' ) && $this->canDelete && $this->item->intIdContrato_ctr != 0  ){
        if ( $this->item->intIdAgenda_ag != 0 && $this->canDelete && $this->canDo->get( 'core.delete' ) ){
            $bar->appendButton( 'Standard', 'delete', JText::_( 'COM_AGENDAS_ELIMINAR' ), 'agenda.delete', false );
        }

        $bar->appendButton( 'Separator' );

        $bar->appendButton( 'Standard', 'cancel', JText::_( 'COM_AGENDAS_CANCELAR' ), 'agenda.cancel', false );
    ...
    protected function setDocument()
    {
        ...
        $document->addScript( JURI::root() . 'components/com_agendas/views/agenda/assets/Agenda.js' );

        //  Adjunto libreria para la gestion de los detalles de agendas
        $document->addScript( JURI::root() . 'components/com_agendas/views/agenda/assets/DetalleAgd.js' );
        $document->addScript( JURI::root() . 'components/com_agendas/views/agenda/assets/GestionDetalleAgd.js' );
        $document->addScript( JURI::root() . 'components/com_agendas/views/agenda/assets/GestionDetallesAgd.js' );

        //  Adjunto libreria para la gestion de la estructura de agendas
        $document->addScript( JURI::root() . 'components/com_agendas/views/agenda/assets/EstructuraAgd.js' );
        $document->addScript( JURI::root() . 'components/com_agendas/views/agenda/assets/GestionEstructuraAgd.js' );
        $document->addScript( JURI::root() . 'components/com_agendas/views/agenda/assets/GestionEstructurasAgd.js' );

        //  Adjunto libreria para la gestion de la estructura de agendas
        $document->addScript( JURI::root() . 'components/com_agendas/views/agenda/assets/ItemAgd.js' );
        $document->addScript( JURI::root() . 'components/com_agendas/views/agenda/assets/GestionItemAgd.js' );
        $document->addScript( JURI::root() . 'components/com_agendas/views/agenda/assets/GestionItemsAgd.js' );

        //  Adjunto libreria para el lenguaje
        $document->addScript( JURI::root() . 'components/com_agendas/views/agenda/assets/ES_AGENDA.js' );

        //  Adjunto libreria que controla ingreso de informacion especifica en los campos
        $document->addScript( JURI::root() . 'components/com_agendas/views/agenda/assets/Reglas.js' );
        ...
        JText::script( 'COM_AGENDAS_AGENDA_ERROR_UNACCEPTABLE' );
    }

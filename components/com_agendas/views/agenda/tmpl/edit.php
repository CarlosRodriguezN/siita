    ...
    <div class="m">
        ...
        <div class="pagetitle icon-48-contact">
            <h2> <?php if ($this->item->intIdAgenda_ag == null): ?>
                    <?php echo JText::_('COM_AGENDAS_AGENDA_CREATING'); ?>
                <?php else: ?>
                    <?php echo JText::_('COM_AGENDAS_AGENDA_EDITING'); ?>
                <?php endif; ?>
            </h2>
        </div>
    </div>
    ...
    <div class="m">
        <form action="<?php echo JRoute::_('index.php?option=com_mantenimiento&layout=edit&intIdAgenda_ag=' . (int) $this->item->intIdAgenda_ag); ?>" method="post" name="adminForm" id="agenda-form" >
            ...
            <div id="tabsAgenda" style="position: static; left: 20px; height: auto; width: 100%">
                <ul>
                    <li><a href="#dtaAgenda" title="<?php echo JText::_( 'COM_AGENDAS_FIELD_AGENDA_DATA_GENERAL_DESC' ); ?>"> <?php echo JText::_('COM_AGENDAS_FIELD_AGENDA_DATA_GENERAL_LABEL') ?></a></li>
                    <li><a href="#detalleAgd" title="<?php echo JText::_( 'COM_AGENDAS_FIELD_AGENDA_DETALLE_DESC' ); ?>"> <?php echo JText::_('COM_AGENDAS_FIELD_AGENDA_DETALLE_LABEL') ?></a></li>
                    <li><a href="#estructuraAgd" title="<?php echo JText::_( 'COM_AGENDAS_FIELD_AGENDA_ESTRUCTURA_DESC' ); ?>"> <?php echo JText::_('COM_AGENDAS_FIELD_AGENDA_ESTRUCTURA_LABEL') ?></a></li>
                    <li><a href="#itemsAgd" id="controlItmEtr" title="<?php echo JText::_( 'COM_AGENDAS_FIELD_AGENDA_ITEM_DESC' ); ?>"> <?php echo JText::_('COM_AGENDAS_FIELD_AGENDA_ITEM_LABEL') ?></a></li>
                </ul>

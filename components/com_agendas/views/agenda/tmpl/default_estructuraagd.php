...
<div class="width-60 fltlft">
    <fieldset class="adminform">
        <legend> <?php echo JText::_('COM_AGENDAS_FIELD_AGD_ESTRUCTURA_LABEL') ?> </legend>
        <div class="fltrt">
        ...
        <table id="tbEstructura" width="100%" class="tablesorter" cellspacing="1">
            <thead>
                <tr>
                    <th align="center"><?php echo JText::_( 'COM_AGENDAS_FIELD_AGD_ESTRUCTURA_DESCRIPCION_LABEL' ) ?></th>
                    <th align="center"><?php echo JText::_( 'COM_AGENDAS_FIELD_AGD_ESTRUCTURA_PADRE_LABEL' ) ?></th>
                    <th align="center"><?php echo JText::_( 'COM_AGENDAS_FIELD_AGD_ESTRUCTURA_NIVEL_LABEL' ) ?></th>
        ...
        <div id="srEtr" align="center" class="hide"> <p> <?php echo JText::_( 'COM_AGENDAS_SIN_REGISTROS' ); ?> </p> </div>
    </fieldset>
</div>

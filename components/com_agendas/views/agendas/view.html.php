 ...
 */
class AgendasViewAgendas extends JView
{
    /**
    ...
    */
    ...
    function display($tpl = null) 
    {
        ...
        //  la cual internamente accede al "AgendasModelAgenda" y ejecuta el metodo "getItems"
        ...
        //  "AgendasModelAgendas" del modelo
    ...
    */
    protected function getToolbar() 
    {
        ...
        if( $this->canDo->get( 'core.create' ) || $this->canDo->get( 'core.edit' ) ){
            $bar->appendButton( 'Standard', 'new', JText::_('COM_AGENDAS_NUEVO'), 'agenda.add', false );
        }
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root(). 'components/com_agendas/views/agendas/assets/Reglas.js' );
        
        JText::script('COM_AGENDAS_AGENDAS_ERROR_UNACCEPTABLE');
    }
}

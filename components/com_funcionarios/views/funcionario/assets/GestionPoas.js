...
GestionPoas.prototype.makeFilaPOA = function( objPOA, ban )
{
    ...
    if ( typeof (objPOA.idPadrePoa) != "undefined" && objPOA.idPadrePoa != 0 || ( roles["core.create"] === true || roles["core.edit"] === true ) ) {
        ...
        fila += '   <td class="center" style="width: 12px;" > <a onclick="SqueezeBox.fromElement( \'index.php?option=com_funcionarios&view=poa&layout=edit&id=' + objPOA.idRegPoa + '&padre=0&idEntidad=' + objPOA.idEntidadPoa + '&op=1&tmpl=component&task=preview\', {size:{x:700 ,y:400}, handler:\'iframe\'} );"> ' + JSL_ACTUALIZAR + ' </a> </td>';

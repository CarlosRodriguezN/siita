...
// Inicializo la variable para el id de registro del plan vigente
$regPoa = -1;
?>
...
<div class="width-100 fltlft" >
    <div class="width-35 fltlft">
            ...
            <div class='m'>
                <div id="lstPoas">
                    <?php if( $this->item->intCodigo_fnc > 0  ): ?>
                        <?php if( $this->canDo->get( 'core.create' ) ): ?>
                            <div> 
                                <a href= "index.php?option=com_funcionarios&view=poa&layout=edit&id=0&op=0&padre=0&idEntidad=<?php echo $this->item->intIdentidad_ent ?> &tmpl=component&task=preview" class="modal" rel="{handler: 'iframe', size: {x:700, y:400}}">
                                    <input class="fltrt" type="button" value=" &nbsp;<?php echo JText::_('BTN_NUEVO_PLAN') ?> &nbsp;">
                                </a>
                            </div> 
                        <?php endIf; ?>

                        <?php if( count( $this->lstPoasFnc ) > 0  ): ?>
                        <div id="tbPoas">
                        <?php else: ?>
                            ...
                            <table id="tbLstPoas" class="adminlist">
                                <thead> 
                                    <tr>
                                        ...
                                        <th align="center"> <?php echo JHtml::_('grid.sort', 'COM_FUNCIONARIOS_FIELD_NOMBRE_ENTIDAD_LABEL', 'descripcionPoa', $listDirn, $listOrder); ?> </th>
                        ...
                        <div id="srPoas" align="center" style="display: none;" > 
                            <p> <?php echo JText::_( 'COM_FUNCIONARIOS_SIN_REGISTROS' ); ?> </p> 
                        </div>
                    ...
                    <?php else: ?>
                        <div> 
                            <label> <?php echo JText::_('SMS_SAVE_DATA_GENERAL') ?> </label>
                        </div> 
                    <?php endif; ?>
    ...
    <div class="width-65 fltrt">
        <fieldset class="adminform">
            <legend> <div id="idLstPOAsFUG"> <?php echo JText::_('COM_FUNCIONARIOS_FIELD_OBJETIVOS_FNC_LABEL') ?> </div> </legend>
                <!-- Lista de Objetivos de un Poa de una Unidad de Gestion -->
                <div class="width-55 fltlft">
                    <div class="fltrt">
                        <input id="poaObjs" class="addObjetivoPoa" type="button" value=" &nbsp;<?php echo JText::_('BTN_AGREGAR') ?> &nbsp;">
                    </div> 
                    <table id="tbLstObjetivos" width="100%" class="tablesorter" cellspacing="1">
                        <thead>
                            <tr>
                                <th align="center"><?php echo JText::_('COM_FUNCIONARIOS_FIELD_OBJETIVO_DESCRIPCION_LABEL') ?></th>
                                <th align="center"><?php echo JText::_('COM_FUNCIONARIOS_FIELD_OBJETIVO_PRIORIDAD_LABEL') ?></th>
                                <th colspan="4" align="center"><?php echo JText::_('COM_FUNCIONARIOS_FIELD_COMPLEMENTO') ?></th>
                    ...
                    <div id="srObj" align="center" style="display: none;"> 
                        <p> <?php echo JText::_( 'COM_FUNCIONARIOS_SIN_REGISTROS' ); ?> </p> 
                    </div>
                </div>

                <!--    Fomulario para registrar un nuevo objetivo del FUNCIONARIOS-->
                    ...
                    <div id="frmObjetivo" class ="hide" >
                        <fieldset class="adminform">
                            ...
                            <ul class="adminformlist">
                                ...
                                <li>
                                    <label id="jform_intPrioridad_ob-lbl" for="jform_intPrioridad_ob" class="hasTip required" title="Prioridad::Prioridad del objetivo"><?php echo JText::_('COM_FUNCIONARIOS_FIELD_OBJETIVO_PRIORIDAD_LABEL') ?><span class="star">&#160;*</span></label>
                                    <select id="jform_intPrioridad_ob" name="jform[intPrioridad_ob]">   <option value="0"><?php echo JText::_('COM_FUNCIONARIOS_FIELD_OBJETIVO_PRIORIDAD_TITLE') ?></option>
                                        <option value="1" >ALTA</option>
                                        <option value="2" >MEDIA</option>
                                        <option value="3" >BAJA</option></select>
                                </li>
                                <li>
                                    <label id="jform_strDescripcion_ob-lbl" for="jform_strDescripcion_ob" class="hasTip required" title="Descripción::Nombre del objetivo"><?php echo JText::_('COM_FUNCIONARIOS_FIELD_OBJETIVO_DESCRIPCION_LABEL') ?><span class="star">&#160;*</span></label>

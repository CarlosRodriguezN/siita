...
<div class="width-60 fltlft" >
    <fieldset class="adminform">
        <legend>&nbsp; <?php echo JText::_( 'COM_FUNCIONARIOS_FIELD_LST_ACTIVIDADES' ) ?>&nbsp; </legend>
        <div class="fltrt">
        ...
        <table id="tbLstPlanAccion" width="100%" class="tablesorter" cellspacing="1">
            <thead>
                <tr>
                    <th align="center"><?php echo JText::_( 'COM_FUNCIONARIOS_FIELD_PLAN_ACCION_DESCRIPCION_LABEL' ) ?></th>
                    <th align="center"><?php echo JText::_( 'COM_FUNCIONARIOS_FIELD_PLAN_ACCION_TIPO_ACCION_LABEL' ) ?></th>
                    <th align="center"><?php echo JText::_( 'COM_FUNCIONARIOS_FIELD_PLAN_ACCION_PRESUPUESTO_LABEL' ) ?></th>
                    <th align="center"><?php echo JText::_( 'COM_FUNCIONARIOS_FIELD_PLAN_ACCION_FECHA_EJECUCION_LABEL' ) ?></th>
                    <th align="center"><?php echo JText::_( 'COM_FUNCIONARIOS_FIELD_PLAN_ACCION_FECHA_FIN_LABEL' ) ?></th>
...
<div class="width-40 fltrt" >
    ...
    <div id="frmPlnAccion" class ="hide" >
        ...
        <fieldset class="adminform">
            ...
            <fieldset class="adminform">
                <legend> &nbsp;<?php echo JText::_( 'COM_FUNCIONARIOS_FIELD_FUNCIONARIO_LABEL' ) ?>&nbsp; </legend>
                <ul class="adminformlist">
            ...
            <fieldset class="adminform">
                <legend> &nbsp;<?php echo JText::_( 'COM_FUNCIONARIOS_FIELD_FUNCIONARIOS_LABEL' ) ?>&nbsp; </legend>
                <ul class="adminformlist">

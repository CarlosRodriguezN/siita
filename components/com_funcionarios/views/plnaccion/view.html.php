...
class FuncionariosViewPlnAccion extends JView
{
    ...
    protected function setDocument()
    {
        ...
        $document->addScript( JURI::root() . 'components/com_funcionarios/views/plnaccion/assets/ES_ACCION.js' );

        //  Adjunto libreria que controla ingreso de informacion especifica en los campos
        $document->addScript( JURI::root() . 'components/com_funcionarios/views/plnaccion/assets/ReglasPA.js' );

        //  Adjunto libreria que controla ingreso de informacion especifica en los campos
        $document->addScript( JURI::root() . 'components/com_funcionarios/views/plnaccion/assets/Accion.js' );

        //  Adjunto libreria para actualizacion de los combos vinculantes
        $document->addScript( JURI::root() . 'components/com_funcionarios/views/plnaccion/assets/Vinculantes.js' );

        //  Adjunto libreria que controla ingreso de informacion especifica en los campos
        $document->addScript( JURI::root() . 'components/com_funcionarios/views/plnaccion/assets/GestionAcciones.js' );
        
        //  Adjunto libreria para el contro de los botonee de guarad y cancelar del livebox
        $document->addScript( JURI::root() . 'components/com_funcionarios/views/plnaccion/assets/Save.js' );

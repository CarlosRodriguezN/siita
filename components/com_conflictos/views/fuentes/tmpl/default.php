...
<div id="toolbar-box">
    <div class="m">
        ...
        <div class="pagetitle icon-48-contact">
            <h2>
                <?php echo JText::_( 'COM_CONFLICTOS_GESTION_FUENTES' ); ?>
            </h2>
        </div>
...
<div id="element-box">
    <div class="m">
        <form action="<?php echo JRoute::_( 'index.php?option=com_conflictos&amp;view=fuentes' ); ?>" method="post" name="adminForm" id="adminForm">

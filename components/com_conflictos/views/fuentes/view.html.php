 ...
 */
class ConflictosViewFuentes extends JView
{
    /**
    ...
    */
    protected function getToolbar() 
    {
        ...
        if( $this->canDo->get( 'core.create' ) ){
            $bar->appendButton( 'Standard', 'new', JText::_( 'BTN_NUEVO' ), 'fuente.add', false );
        }
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->addScript( JURI::root() . 'components/com_conflictos/views/fuentes/assets/rules.js' );
        
        $document->setTitle( JText::_( 'COM_CONFLICTOS_GESTION_FUENTES' ) );
    }
}
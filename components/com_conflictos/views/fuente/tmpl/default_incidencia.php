...
<div class="width-100 fltlft">
    <div class="width-50 fltrt">
        <div id="imgeIncidenaciaFuente" class="editbackground"></div>    
        <div id="formIncidenaciaFuente" class="hide" >
            <fieldset class="adminform">
                <legend>&nbsp;<?php echo JText::_( "COM_CONFLICTOS_TAB_INCIDENCIA_TITLE" ) ?>&nbsp;</legend>
                <ul class="adminformlist" id="formIncidenciaFnt">
                    <?php  if ( $this->admin ): ?>
                        <?php foreach( $this->form->getFieldset( 'incidenciaFuente' ) as $field ): ?>
                ...
                <div class="clr"></div>
                <?php if( $this->canDo->get( 'core.create' ) || $this->canDo->get( 'core.edit' ) ): ?>
                    <input id="saveIncidenciaFuente" type="button" value=" &nbsp;<?php echo JText::_( 'BTN_GUARDAR' ); ?> &nbsp;">
                <?php endif;?>

                <input id="cancelIncidenciaFuente" type="button" value=" &nbsp;<?php echo JText::_( 'BTN_CANCELAR' ); ?> &nbsp;">
            </fieldset>
        </div>
    </div>
    <div class="width-50 fltleft">
        <fieldset class="adminform">
            <legend>&nbsp;<?php echo JText::_( "COM_CONFLICTOS_TAB_INCIDENCIA_LSTTITLE" ) ?>&nbsp;</legend>
            <div class="fltrt">  
                <input id="addIncidenciaFuente" type="button" value=" &nbsp;<?php echo JText::_( 'BTN_AGREGAR' ); ?> &nbsp;">
            </div> 

...
<div id="content-box">
    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-contact">
                <h2> <?php echo JText::_( 'COM_PANEL_CYM' ) . JText::_( 'COM_PANEL_UNIDAD_GESTION_TITLE' )?> </h2>
            </div>
        </div>
    </div>
    ...
    <form id="adminForm" action="index.php?option=com_panel" name="adminForm">
        <div id="element-box">
            <div id="system-message-container"></div>

            <div class="m">

                <?php   echo JHtml::_( 'tabs.start', 'tab_group_id', $this->_options );
                
                        echo JHtml::_( 'tabs.panel', JText::_('COM_PANEL_UG_INDICADORES'), 'panel_1_id' ); ?>
                ...
                <?php   echo JHtml::_( 'tabs.panel', JText::_('COM_PANEL_UG_ACCIONES'), 'panel_2_id' ); ?>
                        <iframe src="<?php echo $this->_ticketTableuAccion;?>?:embed=yes&:customViews=no&:tabs=no&:toolbar=no&:refresh" width="100%" height="1000px" frameborder='0'></iframe>                        
        ...
        <div>
            <input type="hidden" name="option" value="com_panel" />

 ...
 * 
 */
class PanelViewStp extends JView
{
    ...
    //  protected $items =  array( 'Secretar&iacutea T&eacute;cnica de Provincial Sucumb&iacute;os' );
    ...
    function display( $tpl = null )
    {
        ...
        $this->_ticketTableu = $this->_getTicketTableu( 'SecretariasTcnicasProvinciales/ScorecarddeSecretariasTcnicas' );
    ...
    protected function getToolbar()
    {
        ...
        $bar->appendButton( 'Standard', 'list', JText::_( 'COM_PANEL_STP_GESTION' ), 'peis.lista', false );
    ...
    protected function setDocument()
    {
        ...
        //  Adjunto libreria que permite el trabajo con pestañas
        $document->addScript( JURI::root() . 'components/com_panel/views/stp/assets/reglas.js' );        
    }

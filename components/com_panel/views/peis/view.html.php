 ...
 * 
 */
class PanelViewPeis extends JView
{
    protected $canDo;
    ...
    function display( $tpl = null )
    {
        ...
        $mdPei = $this->getModel();
        $this->items = $mdPei->lstOEI();        

        $this->canDo = PanelHelper::getActions();
        $this->_ticketTableu = $this->_getTicketTableu( 'ScoreCarddeEvaluacindeIndicadores/ScorecarddeIndicadores' );
    ...
    protected function getToolbar()
    {
        ...
        $bar->appendButton( 'Standard', 'list', JText::_( 'COM_PANEL_LISTA_PEI' ), 'peis.lista', false );
    ...
    protected function setDocument()
    {
        ...
        //  Adjunto libreria que permite el trabajo con pestañas
        $document->addScript( JURI::root() . 'components/com_panel/views/peis/assets/reglas.js' );
    }
}

 ...
 * 
 */
class PanelViewProyectos extends JView
{
    ...
    function display( $tpl = null )
    {
        ...
        $this->_ticketTableu = $this->_getTicketTableu( 'AnlisisdeProyectos/ANALISISDEPROYECTOS' );
    ...
    protected function getToolbar()
    {
        ...
        $bar->appendButton( 'Standard', 'list', JText::_( 'COM_PANEL_LISTA_PROYECTOS' ), 'proyectos.lista', false );

 ...
 * 
 */
class PanelViewFuncionarios extends JView
{
    /**
    ...
    function display( $tpl = null )
    {
        ...
        $this->_ticketTableu = $this->_getTicketTableu( 'AnlisisdeFuncionarios/ANALISISDEFUNCIONARIOS' );
    ...
    protected function getToolbar()
    {
        ...
        $bar->appendButton( 'Standard', 'list', JText::_( 'COM_PANEL_LISTA_FUNCIONARIOS' ), 'funcionarios.lista', false );
    ...
    protected function setDocument()
    {
        ...
        //  Adjunto libreria que permite el trabajo con pestañas
        $document->addScript( JURI::root() . 'components/com_panel/views/proyectos/assets/reglas.js' );
    }
}
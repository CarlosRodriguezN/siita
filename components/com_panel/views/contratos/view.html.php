 ...
 * 
 */
class PanelViewContratos extends JView
{
    ...
    function display( $tpl = null )
    {
        ...
        $this->_ticketTableu = $this->_getTicketTableu( 'AnlisisdeContratos/ScorecarddeContratos' );
    ...
    protected function getToolbar()
    {
        ...
        $bar->appendButton( 'Standard', 'list', JText::_( 'COM_PANEL_LISTA_CONTRATOS' ), 'contratos.lista', false );
    ...
    protected function setDocument()
    {
        ...
        //  Adjunto libreria que permite el trabajo con pestañas
        $document->addScript( JURI::root() . 'components/com_panel/views/contratos/assets/reglas.js' );
    }

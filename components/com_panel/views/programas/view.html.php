 ...
 * 
 */
class PanelViewProgramas extends JView
{
    ...
    function display( $tpl = null )
    {
        ...
        $this->items = $mdPrograma->lstIndicadores();
        
        $this->canDo = PanelHelper::getActions();
        $this->_ticketTableu = $this->_getTicketTableu( 'SeguimientodeInformacinSectorial/SeguimientodeReddeInformacinSectorial' );
    ...
    protected function getToolbar()
    {
        ...
        $bar->appendButton( 'Standard', 'list', JText::_( 'COM_PANEL_LISTA_PROGRAMA' ), 'programas.lista', false );
    ...
    protected function setDocument()
    {
        ...
        //  Adjunto libreria que permite el trabajo con pestañas
        $document->addScript( JURI::root() . 'components/com_panel/views/programas/assets/reglas.js' );

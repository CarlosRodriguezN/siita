    ...
    <div id="toolbar-box">
        <div class="m">
            ...
            <div class="pagetitle icon-48-contact">
                <h2> <?php echo JText::_( 'COM_PANEL_CYM' ) . JText::_( 'COM_PANEL_PROGRAMA_TITLE' ) ?> </h2>
            </div>
        </div>
    </div>
                    ...
                    <div class="adminform">
                        <div class="cpanel-page">
                            <div class="cpanel">
                                ...
                                <div class='tableauPlaceholder' style='width: 1355px; height: 591px;'>
                                    <object class='tableauViz' width='1355' height='591' style='display:none;'>
                                        <param name='host_url' value='http%3A%2F%2F201.218.5.248%2F' /> 
                                        <param name='site_root' value='&#47;t&#47;siitadev' />
                                        <param name='name' value='InformedeIndicadores&#47;InformedeIndicadores' />

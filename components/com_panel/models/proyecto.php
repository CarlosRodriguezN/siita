 ...
 * PEI List Model
 */
class PanelModelProyecto extends JModelList
{
    ...
    public function lstIndicadores( $idIndEntidad )
    {
        ...
        $lstProyectosVigentes = $this->_lstProyectosSinPrograma( $idIndEntidad );
     ...
     * 
     */
    private function _lstProyectosSinPrograma( $idIndEntidad )
    {
        $db = JFactory::getDBO();
        ...
        $query->where( 't1.intIdEntidad_ent = ' );

...
class ContentModelArticles extends JModelList
{
    ...
    function getListQuery()
    {
        ...
        $query->select(
                $this->getState(
                        'list.select', 'a.id, a.title, a.alias, a.title_alias, a.introtext, ' .
    ...
    public function getItems()
    {
        ...
        foreach( $items as &$item ){
            ...
            if( (JRequest::getString( 'layout' ) == 'blog') || (JRequest::getString( 'view' ) == 'featured') || ($this->getState( 'params' )->get( 'layout_type' ) == 'blog') ){

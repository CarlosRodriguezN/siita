...
class jTableRango extends JTable
{
    /**
    * Constructor
    *
    ...
    */
    ...
    /**
     * 
     * Elimino todos los rangos asociados a un determinado indicador entidad
     * 
     ...
     * 
     */
    public function deleteAllRangos( $idIndEntidad )
    {
        try {
            $db = JFactory::getDBO();
            $query = $db->getQuery(true);
            
            $query->delete( '#__ind_rango_gestion' );

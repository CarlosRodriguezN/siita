...
<body id="minwidth-body">
	<div id="border-top" class="h_blue">
		<span class="logo"><a href="http://www.joomlaspanish.org" target="_blank"><img src="templates/<?php echo  $this->template ?>/images/logoSIITA.png" alt="Joomla! Spanish" /></a></span>

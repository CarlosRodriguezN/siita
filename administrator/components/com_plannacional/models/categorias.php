...
//        $categorias = JTable::getInstance( 'Categoria', 'PlanNacionalTable', array() );
//        $items = $categorias->getLstCategorias();
    ...
    public function getListQuery()
    {
        ...
        if( $published == '' ){
            $query->where( '( c.published = 1 OR c.published = 0 )' );
        } else if( $published != '*' ){
        ...
        if( !empty ( $search ) ){
            ...
            $field_searches = " c.STRDESCRIPCIONCATEGORIA LIKE '". $search ."' ";

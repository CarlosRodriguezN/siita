...
class PlanNacionalViewObjetivosNacionales extends JView
{
    ...
    */
    ...
    {
        JToolBarHelper::title(JText::_( 'COM_PLANNACIONAL_MANAGER_OBJETIVONACIONAL' ), 'objetivonacional' );
        
        JToolBarHelper::addNewX('objetivonacional.add');
        JToolBarHelper::editListX('objetivonacional.edit');
        ...
        JToolBarHelper::publish( 'objetivosnacionales.publish' );
                
        //  Muestra la opcion para des publicar una determinada( seleccionada ) actividad
        JToolBarHelper::unpublish( 'objetivosnacionales.unpublish' );
        
        //  Muestra un separador de tarea de la barra de herramientas
        JToolBarHelper::divider();
        
        JToolBarHelper::deleteListX( '', 'objetivosnacionales.delete' );
    }

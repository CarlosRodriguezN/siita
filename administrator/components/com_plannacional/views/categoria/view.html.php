...
class PlanNacionalViewCategoria extends JView
{
    ...
    */
    protected function addToolBar() 
    {
        ...
        $isNew = ( $this->item->intCodigoCategoria == 0 );
        
        JToolBarHelper::title( $isNew   ? JText::_('COM_PLANNACIONAL_ADD_CATEGORIA_TITLE') 
                                        : JText::_('COM_PLANNACIONAL_EDIT_CATEGORIA_TITLE'), 'categoria' );
        
        JToolBarHelper::save( 'categoria.save' );
        JToolBarHelper::cancel( 'categoria.cancel', $isNew  ? 'JTOOLBAR_CANCEL' 
                                                            : 'JTOOLBAR_CLOSE' );
    }
    ...
    */
    protected function setDocument() 
    {
        ...
        $document->setTitle( $isNew ? JText::_( 'COM_PLANNACIONAL_CATEGORIA_CREATING' ) 
                                    : JText::_( 'COM_PLANNACIONAL_CATEGORIA_EDITING' ) );

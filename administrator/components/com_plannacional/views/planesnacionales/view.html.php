...
class PlanNacionalViewPlanesNacionales extends JView
{
    ...
    */
    ...
    {
        JToolBarHelper::title(JText::_( 'COM_PLANNACIONAL_MANAGER_PLANNACIONAL' ), 'plannacional' );
        
        JToolBarHelper::addNewX('plannacional.add');
        JToolBarHelper::editListX('plannacional.edit');
        ...
        JToolBarHelper::publish( 'planesnacionales.publish' );
                
        //  Muestra la opcion para des publicar una determinada( seleccionada ) actividad
        JToolBarHelper::unpublish( 'planesnacionales.unpublish' );
        
        //  Muestra un separador de tarea de la barra de herramientas
        JToolBarHelper::divider();
        
        JToolBarHelper::deleteListX( '', 'planesnacionales.delete' );
    }

...
class PlanNacionalViewPoliticasNacionales extends JView
{
    ...
    */
    ...
    {
        JToolBarHelper::title(JText::_( 'COM_PLANNACIONAL_MANAGER_POLITICANACIONAL' ), 'politicanacional' );
        
        JToolBarHelper::addNewX('politicanacional.add');
        JToolBarHelper::editListX('politicanacional.edit');
        ...
        JToolBarHelper::publish( 'politicasnacionales.publish' );
                
        //  Muestra la opcion para des publicar una determinada( seleccionada ) actividad
        JToolBarHelper::unpublish( 'politicasnacionales.unpublish' );
        
        //  Muestra un separador de tarea de la barra de herramientas
        JToolBarHelper::divider();
        
        JToolBarHelper::deleteListX( '', 'politicasnacionales.delete' );
    }

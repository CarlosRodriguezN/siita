...
class PlanNacionalViewCategorias extends JView
{
    ...
    */
    ...
    {
        JToolBarHelper::title(JText::_( 'COM_PLANNACIONAL_MANAGER_CATEGORIA' ), 'categoria' );
        ...
        JToolBarHelper::publish( 'categorias.publish' );
                
        //  Muestra la opcion para des publicar una determinada( seleccionada ) actividad
        JToolBarHelper::unpublish( 'categorias.unpublish' );

...
<form action="index.php?option=com_swmenupro&task=imageFiles&tmpl=component" id="uploadForm" method="post" enctype="multipart/form-data">
...
<?php } ?>
	...
	<iframe src="index.php?option=com_swmenupro&task=imageFiles&tmpl=component" name="imgManager" id="imgManager" class="imageFrame" scrolling="auto" title="Image Selection" frameborder="0"></iframe>
</div>
</fieldset>
<!-- image properties -->

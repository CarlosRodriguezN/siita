...
function accordianConfig( $rows,$row2, $menutype,$pageNav, $mainpadding, $subpadding, $mainborder, $subborder, $mainborderover, $subborderover, $modulename, $ordered, $parent_id,$orders2, $lists,$orders3,$moduleclass_sfx)
{
	global $mainframe;
...
<table  cellpadding="4" cellspacing="4" border="0" width="750">
  <tr>
     ...
     <td valign="bottom"><span class="swmenu_sectionname"><?php echo _SW_ACCORDIAN_MENU." "._SW_MODULE_EDITOR; ?></span> </td>
     <td valign="top" >
      <ul>
...
<input type="hidden" name="menustyle" value="accordian" />

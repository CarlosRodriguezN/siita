...
function superfishMenuConfig( $rows,$row2, $menutype,$pageNav, $mainpadding, $subpadding, $mainborder, $subborder, $mainborderover, $subborderover, $modulename, $ordered, $parent_id,$orders2, $lists,$orders3,$moduleclass_sfx)
{
	global $mainframe;
...
<table  cellpadding="4" cellspacing="4" border="0" width="750">
  <tr>
     ...
     <td valign="bottom"><span class="swmenu_sectionname"><?php echo "Superfish  "._SW_MODULE_EDITOR; ?></span> </td>
     <td valign="top" >
      <ul>
...
<table width="100%">
  <tr>
    <td align="center"> <img src="components/com_swmenupro/images/superfish_offsets.png" width="750" height="480" border="0" hspace="0" vspace="0"/> </td>
  </tr>
</table>
...
<input type="hidden" name="menustyle" value="superfishmenu" />

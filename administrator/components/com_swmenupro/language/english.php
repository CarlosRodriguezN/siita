...
define( '_SW_PADDING_HACK_TIP', 'If you have menu item size differences between Internet Explorer 6 and other browsers then try this hack.' );
...
define( '_SW_COPY_SWMENUFREE_BUTTON', 'Click here to copy menu module from swMenuFree to swMenuPro, new menu module will be called swMenuFree Copy' );


//swMenuPro 5.0 new terms

define( '_SW_SLIDECLICK_MENU', 'Moo Tools Accordian Menu' );

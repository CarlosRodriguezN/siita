...
class HTML_swmenupro
{
	...
	<table  cellpadding="4" cellspacing="4" border="0" width="750">
      <tr>
        ...
        <td valign="top"><ul><li><a href="index.php?option=com_swmenupro&task=editDhtmlMenu&id=<?php echo $id; ?>" ><?php echo _SW_MANAGER_LINK; ?></a></li></ul></td>
     </tr>
    </table>
    ...
    <table class="swmenu_tabheading"  width="750">
      <tr>
        ...
        <td><a href="index.php?option=com_swmenupro&task=showmodules"  class="swmenu_button_cancel" onmouseover="return escape('<?php echo _SW_CANCEL_TIP; ?>')"><?php echo _SW_CANCEL_BUTTON; ?></a></td>
      </tr>
   </table>
   <table width="750">
	 <tr>
...
?>
  ...
  <input type="hidden" name="preview" value="3" />
</div>
...
<table  cellpadding="4" cellspacing="4" border="0" width="750">
  <tr>
     ...
     <td valign="top" ><ul><li><a href="index.php?option=com_swmenupro&task=showmodules" ><?php echo _SW_RETURN_MANAGER_LINK; ?></a></li></ul></td>
   </tr>
</table>
...
<tr class="swmenu_menubackgr"><td>
	<a href="index.php?task=import_swMenuFree&option=com_swmenupro" ><?php echo _SW_COPY_SWMENUFREE_BUTTON;?> </a></td>
  </tr>
</table>

...
$registry = new JRegistry();
    ...
    $parent_id = @$params->parentid ? $params->parentid : 1;
...
if($menu && $id && $menustyle){
	//echo "hellpp";
	 ...
	 $ordered = chain('ID', 'PARENT', 'ORDER', $swmenupro_array, 1, $levels);
	...
	//$ordered = $final_menu;
		...
		if ($menustyle == "clicktransmenu"){$content.= doClickTransMenuPreview($ordered, $swmenupro, $css_load, $active_menu, $selectbox_hack, $padding_hack,$parent_id);}
		
		if ($menustyle == "slideclick"){$content.= doSlideClickPreview($ordered, $swmenupro, $css_load, $active_menu, $selectbox_hack, $padding_hack, $parent_id);}
		if ($menustyle == "accordian"){$content.= doAccordianPreview($ordered, $swmenupro, $css_load, $active_menu, $selectbox_hack, $padding_hack, $parent_id, $auto_position);}
		...
		if ($menustyle == "gosumenu" ){$content.= doGosuMenuPreview($ordered, $swmenupro, $active_menu, $css_load,$selectbox_hack,$padding_hack,$auto_position,$show_shadow,$sub_indicator);}
		if ($menustyle == "superfishmenu" ){$content.= dosuperFishMenuPreview($ordered, $swmenupro, $active_menu, $css_load,$selectbox_hack,$padding_hack,$auto_position,$show_shadow,$sub_indicator);}
		...
		if ($menustyle == "dynamictabmenu"){$content.= doDynamicTabMenuPreview($ordered, $swmenupro, $parent_id, $css_load,$active_menu,$padding_hack,$auto_position,0);}
		if ($menustyle == "columnmenu"){$content.= doColumnMenuPreview($ordered, $swmenupro, $parent_id, $css_load,$active_menu,$padding_hack,$auto_position);}
	}
}
...
function doClickTransMenuPreview($ordered, $swmenupro, $css_load, $active_menu,$expand,$padding_hack,$parent_id){
global $mosConfig_live_site;
echo previewHead();
echo '<script type="text/javascript" src="../modules/mod_swmenupro/ClickShowHideMenu_Packed.js"></script>';
...
echo ClickTransMenu($ordered, $swmenupro, $active_menu,$expand,$parent_id,1);
echo changeBgColor();
echo "</div></body></html>";
}
function doSlideClickPreview($ordered, $swmenupro, $css_load, $active_menu,$expand,$padding_hack, $parent_id){
global $mosConfig_live_site;
echo previewHead();
...
echo SlideClick($ordered, $swmenupro, $active_menu,$expand, $parent_id);
echo "</div>".changeBgColor();
echo "</body></html>";
}

function doAccordianPreview($ordered, $swmenupro, $css_load, $active_menu,$expand,$padding_hack, $parent_id, $auto_position){
global $mosConfig_live_site;
echo previewHead();
...
echo Accordian($ordered, $swmenupro, $active_menu, $expand , $parent_id, $auto_position);
echo "</div>".changeBgColor();
echo "</body></html>";
}
...
echo "</head><body>";
echo TigraMenu($ordered, $swmenupro, $active_menu,1);
echo changeBgColor();
echo "</body></html>";
}

function doSuperfishMenuPreview($ordered, $swmenupro, $active_menu, $css_load,$selectbox_hack,$padding_hack,$sub_active,$show_shadow,$sub_indicator){
	echo previewHead();
	//echo "helloaa";
	...
	$manual=JRequest::getVar("preview",1);
if($manual==1){
	$css=JRequest::getVar("filecontent",'');
	echo "\n<style type='text/css'>\n";
	echo "<!--\n";
...
echo "\n<style type='text/css'>\n";
	echo "<!--\n";
echo superfishMenuStyle($swmenupro,$ordered,$sub_indicator);
echo "\n-->\n";
	echo "</style>\n";
}
echo "</head><body>";
...
//echo "again";
echo SuperfishMenu($ordered, $swmenupro, $active_menu,$selectbox_hack,$sub_active,$show_shadow, $sub_indicator,1);
echo "</div>";
	echo changeBgColor();
echo "</body></html>";
}
...
function doGosuMenuPreview($ordered, $swmenupro, $active_menu, $css_load,$selectbox_hack,$padding_hack,$auto_position,$show_shadow,$sub_indicator){
global $mosConfig_live_site;
echo previewHead();
echo '<script type="text/javascript" src="../modules/mod_swmenupro/jquery-1.2.6.pack.js"></script>';
...
echo "\n<style type='text/css'>\n";
	echo "<!--\n";
echo gosuMenuStyle($swmenupro,$ordered,$sub_indicator);
echo "\n-->\n";
	echo "</style>\n";
}
echo "</head><body>";
echo GosuMenu($ordered, $swmenupro, $active_menu,$selectbox_hack,$auto_position,$show_shadow,1);
echo changeBgColor();
echo "</body></html>";
}
...
echo "</head><body>";
echo TabMenu($ordered, $swmenupro, $parent_id, $active_menu,0);
echo changeBgColor();
echo "</body></html>";
...
function doDynamicTabMenuPreview($ordered, $swmenupro, $parent_id,$css_load,$active_menu,$subwrap,$autoclose,$sub_active){
...
echo "</head><body>";
echo DynamicTabMenu($ordered, $swmenupro, $parent_id,$active_menu,$subwrap,$autoclose,$sub_active);
echo changeBgColor();
echo "</body></html>";

}

function doColumnMenuPreview($ordered, $swmenupro, $parent_id,$css_load,$active_menu,$subwrap,$autoclose){

echo previewHead();
echo '<script type="text/javascript" src="../modules/mod_swmenupro/jquery-1.2.6.pack.js"></script>';
echo '<script type="text/javascript" src="../modules/mod_swmenupro/jquery.easing-sooper.js"></script>';
echo '<script type="text/javascript" src="../modules/mod_swmenupro/jquery.sooperfish.js"></script>';
$manual=JRequest::getVar("preview",0);
if($manual==1){
	$css=JRequest::getVar("filecontent",'');
	echo "\n<style type='text/css'>\n";
...
echo "<link type='text/css' href='../modules/mod_swmenupro/styles/menu".$swmenupro['id'].".css' rel='stylesheet' />\n";
	...
	echo "\n<style type='text/css'>\n";
	echo "<!--\n";
echo columnMenuStyle($swmenupro,$ordered,$subwrap);
echo "\n-->\n";
	echo "</style>\n";

}
echo "</head><body>";
echo columnMenu($ordered, $swmenupro, $parent_id,$active_menu,$subwrap,$autoclose,0);
echo changeBgColor();
echo "</body></html>";
...
echo "</head><body>";
echo transMenu($ordered, $swmenupro, $active_menu,  $sub_indicator, $parent_id,$selectbox_hack,$auto_position,1);
echo changeBgColor();
echo "</body></html>";
}

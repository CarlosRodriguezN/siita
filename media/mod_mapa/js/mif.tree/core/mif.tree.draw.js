...
Mif.Tree.Draw = {
    ...
    getHTML: function(node,html) {
        ...
        var inmgDefSrc= "http://" + window.location.host + "/modules/mod_mapa/assets/images/default.png";  
        html = html||[];
        ...
        switch(node.type[0]) {
            case "programa":
                html.push(
                    ...
                    '<span> <img src="modules/mod_mapa/assets/programas/',node.data.id,'.png" onerror="this.src=\'' + inmgDefSrc + '\'" title="',node.name,'" width="15" height="15"></span>',
            ...
            case "proyecto":
                html.push(
                    ...
                    checkbox,
                    '<span class="mif-tree-icon" > </span>',
                    '<span> <img src="modules/mod_mapa/assets/proyTreeImages/',node.data.id,'.png" onerror="this.src=\'' + inmgDefSrc + '\'" title="',node.name,'" width="15" height="15"></span>',
                    '<span class="mif-tree-name" uid="',node.UID,'">',node.name,' (',node.children.length,')','</span>',
                    '</span>',
                    '<div class="mif-tree-children" style="display:none"></div>',
                    '</div>'
